...
// ═══════════════════════════════════════════════════════════════════════════
  ...
  // ── 1. GASTROENTERITIS ─────────────────────────────────────────────────
  {
    ...
    focus: 'Pediatrics / Emergency',
    level: 'Intermediate',
    summary: '7-year-old male with 3-day nausea, vomiting, diarrhea, fever, and lethargy. Presents to ED with severe dehydration, BP 86/52. IV bolus, glucose check, developmentally appropriate care, and therapeutic communication with stepmother.',
    skills: ['Pediatric assessment', 'IV fluid bolus', 'Dehydration scoring', 'Therapeutic communication'],
    patient: patientTemplate({
      id: 'gastro-default', scenarioId: 'gastroenteritis',
      firstName: 'Max', lastName: 'Sheppard',
      age: '7', sex: 'Male', dob: '6/05', mrn: '51-65001',
      location: 'Emergency Department',
      diagnosis: 'Acute Gastroenteritis with Severe Dehydration',
      acuity: 'Urgent', allergies: 'No Known Allergies',
      specialty: 'Pediatrics / ED',
      tags: ['Pediatric', 'Dehydration', 'IV bolus', 'HCT'],
      gestation: 'N/A',
      chiefComplaint: '3-day nausea, vomiting, diarrhea, and fever',
      hpi: 'Max is a 7-year-old male with a 3-day history of nausea, vomiting, diarrhea, and fever. He presented to the ED 15 minutes ago with his stepmother Mrs. Sheppard, who is concerned because his symptoms are worsening and he recently became lethargic. Average 8 episodes of watery diarrhea/day with no blood or mucus. Vomiting 3× daily with no hematemesis. Last episode 2 hours ago. Refusing oral fluids today. Provider diagnosed acute gastroenteritis with severe dehydration — IV fluids, labs, and PRN medication ordered.',
      background: 'Triage vitals: BP 86/52; HR 128; T 100.8°F (38.2°C) tympanic; RR 26; SpO2 98% RA. 22g IV NS lock in left arm placed in triage, soft and patent. Labs not yet drawn. Mrs. Sheppard (stepmother) at bedside, very concerned.',
      pastHistory: 'No known chronic health conditions. Born 40 weeks, SVD. Immunizations up-to-date. Growing at 50th percentile, meeting milestones. Birth mother deceased (breast cancer, age 2).',
      social: 'Lives with father (Michael Sheppard) and stepmother (Joanna Sheppard). 2nd grade, doing well in school.',
      familyContact: 'Stepmother Joanna Sheppard — at bedside. Father Michael Sheppard — contactable.',
      objectives: [
        'Conduct a focused assessment of a child with acute gastroenteritis.',
        'Prioritize nursing interventions based on the patient\'s condition — fluid bolus first.',
        'Provide developmentally appropriate care and therapeutic communication to the patient and family.',
        'Notify the provider of the patient\'s condition in a clear, concise, structured format.',
      ],
      orders: [
        ['General', 'Admit to Emergency Department', 'Standard Precautions', 'Active'],
        ['Nursing', 'Establish and maintain IV access', 'IV lock in situ — verify patency', 'Active'],
        ['Monitoring', 'Continuous 5-lead ECG and SpO2 monitoring', '', 'Active'],
        ['Nursing', 'Vital signs every 2 hours or as needed', 'Notify for changes in condition', 'Active'],
        ['Lab', 'Check capillary blood glucose', 'Before and after bolus', 'Active'],
        ['Lab', 'BMP (Basic Metabolic Panel)', 'Not yet collected', 'Active'],
        ['IV Fluids', '0.9% Sodium Chloride 454 mL IV bolus over 30 min STAT', '20 mL/kg bolus', 'STAT'],
        ['Medication', 'Acetaminophen chewable 320 mg PO q6h PRN temp ≥ 100.4°F (38°C)', '160 mg/tab × 2 tabs', 'PRN'],
      ],
      labs: [
        ['Triage', 'Blood Glucose (capillary)', 'Pending', '70–110 mg/dL', 'Pending', 'Check before dextrose-containing fluids'],
        ['Triage', 'BMP', 'Pending', 'See reference ranges', 'Pending', 'Not yet drawn'],
      ],
      vitals: [{
        time: 'Triage (15 min ago)', hr: 128, bps: 86, bpd: 52, rr: 26, temp: '100.8',
        spo2: 98, pain: '0', fetal: 'N/A',
        note: 'Lethargic. Decreased skin turgor. Dry mucous membranes. Crying without tears. Tympanic temperature.',
        by: 'Triage RN'
      }],
      meds: [
        ['0.9% Sodium Chloride', '454 mL (20 mL/kg)', 'IV bolus', 'Over 30 min STAT', 'STAT', 'pending', 'Severe dehydration — administer immediately. Reassess after bolus.'],
        ['Acetaminophen chewable', '320 mg (2 × 160 mg tabs)', 'PO', 'q6h PRN T ≥ 100.4°F', 'PRN', 'pending', 'Last dose given 6 hours ago at 1300.'],
      ]
    })
  },
  ...
  {
    id: 'cellulitis_aki',
    name: 'Cellulitis and Acute Kidney Injury',
    focus: 'Medical-Surgical',
    level: 'Intermediate',
    summary: '39-year-old male with intellectual disability, admitted for right arm cellulitis. On day 6 of vancomycin — new labs show acute kidney injury. Requires SBAR to provider, vancomycin discontinuation, and switch to daptomycin.',
    skills: ['Skin assessment', 'IV antibiotics', 'AKI recognition', 'SBAR escalation'],
    patient: patientTemplate({
      id: 'cellulitis-default', scenarioId: 'cellulitis_aki',
      firstName: 'Calvin', lastName: 'Bates',
      age: '39', sex: 'Male', dob: '3/11', mrn: '51-27001',
      location: 'Medical/Surgical Unit',
      diagnosis: 'Cellulitis Right Upper Arm / Acute Kidney Injury',
      acuity: 'Watch', allergies: 'No Known Allergies',
      specialty: 'Medical-Surgical',
      tags: ['Cellulitis', 'AKI', 'Vancomycin', 'HIGH-ALERT', 'HCT'],
      gestation: 'N/A',
      chiefComplaint: 'Right arm redness, swelling, warmth — Day 6 admission',
      hpi: 'Calvin Bates, a 39-year-old male with developmental delays, was admitted 6 days ago for right upper arm cellulitis. Caregiver from his group home noted erythema extending just below the shoulder and over the elbow. Cause unknown — possible insect bite while gardening. He has been receiving vancomycin IV every 8 hours since admission. Current concern: new lab results show acute kidney injury — creatinine elevated from baseline. Provider must be notified.',
      background: 'Triage: HR 96, BP 126/72, RR 18, SpO2 98%, T 101°F (38.3°C). Previous IV removed at 1330 after patient refused replacement during pain. New IV needed before next antibiotic due at 1945. Caregiver Javier currently visiting. Visual pain scale in chart.',
      pastHistory: 'Developmental delays with anxious behaviors, UTI (3 months ago, resolved with 3-day oral antibiotics).',
      social: 'Lives in group home with 24-hr caregiver support. 7 other residents. Sister visits monthly.',
      familyContact: 'Caregiver Javier — currently at bedside. Sister on file.',
      objectives: [
        'Conduct a physical assessment of a patient with cellulitis.',
        'Identify normal and abnormal assessment findings including skin, AKI symptoms.',
        'Prioritize nursing interventions including vancomycin infusion and IV insertion.',
        'Communicate the patient\'s condition and new AKI labs to the provider using SBAR.',
        'Provide therapeutic communication and support to patient and caregiver.',
      ],
      orders: [
        ['Nursing', 'Vital signs every 4 hours and as needed', 'Notify for HR>110, BP>140/90, T>100.5°F, SpO2<90%', 'Active'],
        ['Nursing', 'Establish and maintain IV access', 'Previous IV removed — insert new IV before 1945', 'Active'],
        ['Nursing', 'Monitor intake and output', '', 'Active'],
        ['Diet', 'Regular diet', 'Activity as tolerated', 'Active'],
        ['Lab', 'CBC, CMP, CRP — due 1930', 'Pending', 'Active'],
        ['Lab', 'Vancomycin trough — within 30 min of 2000 dose', 'Pending', 'Active'],
        ['Medication', 'Vancomycin 1750 mg/250 mL IV over 60 min q8h', 'Scheduled dose due 1945 — HOLD pending AKI review', 'Active'],
        ['NEW ORDER', 'STOP vancomycin — switch to daptomycin 500 mg/50 mL IV over 30 min', 'NEW — after provider notified of AKI labs', 'STAT'],
      ],
      labs: [
        ['5 days ago', 'Vancomycin trough', '18.1 mcg/mL', '15–20 mcg/mL', 'Normal', ''],
        ['5 days ago', 'Vancomycin peak', '33.7 mcg/mL', '25–40 mcg/mL', 'Normal', ''],
        ['5 days ago', 'Vancomycin AUC', '594 mcg·hr/mL', '400–600', 'Normal', ''],
        ['Today 1930', 'Creatinine', '2.8 mg/dL', '0.74–1.35 mg/dL', 'Critical', 'CRITICAL — baseline was 0.9 on admission. AKI secondary to vancomycin nephrotoxicity.'],
        ['Today 1930', 'BUN', '38 mg/dL', '8–21 mg/dL', 'High', 'Elevated — consistent with AKI'],
        ['Today 1930', 'WBC', '13.2 K/µL', '5.0–10.0', 'High', 'Improving from admission'],
        ['Today 1930', 'CRP', '42 mg/L', '<1 mg/L', 'High', 'Elevated — cellulitis, trending down'],
      ],
      vitals: [{
        time: '15:19', hr: 96, bps: 132, bpd: 78, rr: 18, temp: '99.2',
        spo2: 98, pain: '5', fetal: 'N/A',
        note: 'Right upper arm: erythematous, swollen, warm. Using visual pain scale. Caregiver present. No IV access currently.',
        by: 'Day shift RN'
      }],
      meds: [
        ['Vancomycin', '1750 mg / 250 mL D5W', 'IV infusion', 'q8h over 60 min', 'Scheduled', 'hold', 'HOLD — new AKI labs. Notify provider before administering.'],
        ['Daptomycin', '500 mg / 50 mL NS', 'IV infusion', 'Over 30 min — NEW ORDER', 'STAT', 'pending', 'New antibiotic replacing vancomycin. Administer after provider confirms switch.'],
        ['Ibuprofen', '600 mg', 'PO', 'q6h PRN mild-moderate pain 1–7', 'PRN', 'pending', 'Assess renal function before giving — AKI present. Hold and notify provider.'],
      ]
    })
  },
 
  // ── 3. POST-OP APPENDECTOMY ────────────────────────────────────────────
  {
    id: 'postop_appendectomy',
    name: 'Post-Op Appendectomy: Wound Infection',
    focus: 'Pediatrics / Emergency',
    level: 'Intermediate',
    summary: '9-year-old male returns to ED 10 days after laparoscopic appendectomy with incision redness, swelling, and pain. Allergic to penicillin. Wound culture, IV antibiotics, and pediatric surgical communication.',
    skills: ['Wound assessment', 'Allergy safety', 'Pediatric post-op care', 'SBAR'],
    patient: patientTemplate({
      id: 'postop-appy-default', scenarioId: 'postop_appendectomy',
      firstName: 'Anthony', lastName: 'Hawkins',
      age: '9', sex: 'Male', dob: '5/5', mrn: '51-48001',
      location: 'Emergency Department',
      diagnosis: 'Post-Op Appendectomy (POD 10) — Surgical Site Infection',
      acuity: 'Urgent',
      allergies: 'Penicillin (anaphylaxis); Peanuts; Strawberries',
      specialty: 'Pediatrics / Surgical',
      tags: ['Pediatric', 'Post-op', 'Allergy:PCN', 'Wound infection', 'HCT'],
      gestation: 'N/A',
      chiefComplaint: 'Incision redness, swelling, and pain — POD 10',
      hpi: 'Anthony Hawkins, a 9-year-old male, has returned to the ED 10 days post-op after laparoscopic appendectomy. He is complaining of swelling, redness, and increased pain localised to the surgical incisions. Dr. Stone (Pediatric Surgeon) performed the surgery. He spent 3 inpatient nights and was discharged with stable vitals, controlled pain, and adequate oral intake.',
      background: 'Has not yet been triaged — in-depth medical history, vital signs, and full assessment not obtained. Alert and ambulatory on arrival with parents.',
      pastHistory: 'Laparoscopic appendectomy 10 days ago. No other chronic conditions. Immunizations up-to-date.',
      social: 'Lives with mother (Gloria) and father (Gerard). One sibling — 2-month-old brother. 3rd grade, doing well.',
      familyContact: 'Father Gerard and mother Gloria Hawkins — at bedside.',
      objectives: [
        'Conduct a focused post-operative assessment of a pediatric patient.',
        'Recognise abnormal findings: fever, wound redness, swelling, drainage at incision.',
        'Prioritise nursing interventions based on findings.',
        'Communicate effectively with the interprofessional team using SBAR.',
        'Provide developmentally appropriate therapeutic communication.',
      ],
      orders: [
        ['Nursing', 'Obtain in-depth history, vital signs, and full assessment', 'Not yet done — priority', 'STAT'],
        ['Nursing', 'Assess surgical wound sites — all laparoscopic incisions', 'Note erythema, swelling, drainage', 'Active'],
        ['IV', 'Obtain peripheral IV access', 'For antibiotics', 'Active'],
        ['Lab', 'CBC and CRP', 'Draw from IV', 'STAT'],
        ['Procedure', 'Clean incision and obtain wound drainage culture', '', 'STAT'],
        ['Procedure', 'Apply dressing to laparoscopic incisions', 'Clean technique', 'Active'],
        ['Medication', 'Ceftriaxone 1820 mg / 100 mL D5W IV', 'NOTE: Penicillin allergy — ceftriaxone is appropriate (different class, low cross-reactivity confirmed)', 'STAT'],
        ['Medication', 'Metronidazole 364 mg / 100 mL NS IV', 'For anaerobic coverage', 'STAT'],
        ['Medication', 'Acetaminophen 160 mg/5 mL suspension PO PRN', 'Per weight-based dosing', 'PRN'],
      ],
      labs: [
        ['Pre-op (10 days ago)', 'Abdominal Ultrasound', 'Acute appendicitis', 'Normal', 'Abnormal', 'Read by Dr. Amber Schoff, Radiologist'],
        ['Pre-op (10 days ago)', 'WBC', '12.4 K/µL', '5.0–10.0', 'High', 'Pre-surgical leukocytosis'],
        ['Pre-op (10 days ago)', 'Hemoglobin', '13.1 g/dL', '12–16', 'Normal', ''],
        ['Today', 'CBC', 'Pending', '', 'Pending', 'Draw with IV'],
        ['Today', 'CRP', 'Pending', '<1 mg/L', 'Pending', 'Expect elevated if wound infected'],
        ['Today', 'Wound Culture', 'Pending', 'No growth', 'Pending', 'Obtain from drainage before antibiotics'],
      ],
      vitals: [{
        time: 'Triage (arrival)', hr: 108, bps: 106, bpd: 64, rr: 22, temp: '101.4',
        spo2: 99, pain: '6', fetal: 'N/A',
        note: 'Incision sites: erythema, oedema, seropurulent drainage noted. Patient guarding abdomen. Ambulatory.',
        by: 'Triage RN'
      }],
      meds: [
        ['Ceftriaxone', '1820 mg / 100 mL D5W', 'IV', 'Once STAT', 'STAT', 'pending', 'ALLERGY CHECK: Penicillin anaphylaxis on file. Ceftriaxone is a cephalosporin — cross-reactivity <2%. Provider confirmed safe to use.'],
        ['Metronidazole', '364 mg / 100 mL NS', 'IV', 'Once STAT', 'STAT', 'pending', 'Anaerobic coverage for wound infection.'],
        ['Acetaminophen', '325 mg/5 mL suspension', 'PO', 'q4-6h PRN pain', 'PRN', 'pending', 'Weight-based dosing for 36.4 kg patient.'],
        ['Morphine Sulfate', '2.4 mg (4 mg/mL, 0.6 mL)', 'IV', 'PRN severe pain', 'PRN', 'pending', 'HIGH-ALERT opioid. Not to be given during scenario without dual verification.'],
      ]
    })
  },
  ...
  {
    id: 'sickle_cell',
    name: 'Sickle Cell Disease: Pain Episode',
    focus: 'Pediatrics / Inpatient',
    level: 'Advanced',
    summary: '6-year-old male admitted with vaso-occlusive pain crisis. Worsening abdominal pain 8/10, Hgb 7.7 g/dL. Requires blood transfusion with dual verification, pain management, and IV fluid management.',
    skills: ['Blood transfusion protocol', 'Dual verification', 'Pediatric pain', 'IV fluids'],
    patient: patientTemplate({
      id: 'sickle-default', scenarioId: 'sickle_cell',
      firstName: 'Xavion', lastName: 'Alexander',
      age: '6', sex: 'Male', dob: '03/08', mrn: '51-98001',
      location: 'Inpatient Pediatric General Care Unit',
      diagnosis: 'Sickle Cell Disease — Vaso-Occlusive Pain Episode',
      acuity: 'Critical', allergies: 'No Known Allergies',
      specialty: 'Pediatrics / Hematology',
      tags: ['Pediatric', 'Sickle Cell', 'HIGH-ALERT Blood Xfusion', 'HIGH-ALERT Morphine', 'HCT'],
      gestation: 'N/A',
      chiefComplaint: 'Abdominal pain 8/10, leg pain, lethargy — morning shift',
      hpi: 'Xavion Alexander is a 6-year-old admitted last evening from the ED for lethargy and pain in abdomen, legs, hands, and feet after outdoor play. Received IV fluid bolus and two doses of morphine in ED with positive results. Overnight, pain fluctuated 5–6 on FACES scale in legs with worsening abdominal pain to 8/10 at 0400. Hot packs not helpful. Morphine administered at 0435 and 0710. IV fluid bolus ordered at 0630 — completed 15 minutes ago. You are the morning shift nurse.',
      background: 'Last vitals at 0430: HR 120; RR 22; BP 90/62; T 98.9°F; SpO2 97% RA. Maintenance IV fluids restarted at 62 mL/hr via 22g peripheral IV left wrist. Provider visited at 0630.',
      pastHistory: 'Sickle Cell Disease (diagnosed age 2), Asthma (diagnosed age 4). Prior hospitalisation: splenic sequestration (treated with blood transfusion 2 years ago).',
      social: 'Lives with mother Ava Alexander, grandmother Nicolette Noble, and 8-year-old sister Devon. Mother at bedside.',
      familyContact: 'Mother Ava Alexander — at bedside. Provider: Dr. Jessica Walters, MD.',
      objectives: [
        'Assess a paediatric patient with sickle cell disease — pain, vital signs, labs.',
        'Prioritise and safely implement interventions including blood transfusion.',
        'Perform dual verification of blood transfusion per protocol.',
        'Communicate patient condition and changes to the provider using SBAR.',
        'Provide therapeutic communication and support to patient and family.',
      ],
      orders: [
        ['Monitoring', 'Continuous SpO2 monitoring', '', 'Active'],
        ['Nursing', 'Incentive spirometer × 5 every 1 hour while awake', '', 'Active'],
        ['Nursing', 'Vital signs every 4 hours or as needed', 'Notify: HR<70 or >120; SBP<90 or >120; RR<12 or >26; SpO2<90%; T>38°C', 'Active'],
        ['IV', 'Maintain IV access — 22g left wrist', 'Maintenance 0.45% NaCl 62 mL/hr', 'Active'],
        ['Diet', 'Regular diet', 'Monitor intake and output', 'Active'],
        ['Lab', 'PT/INR, CBC with differential, CMP — due today 0800', 'Draw from IV or venipuncture', 'Active'],
        ['Medication', 'Folic acid 400 mcg PO suspension daily', '', 'Scheduled'],
        ['Medication', 'Children\'s multivitamin 1 chewable tab PO daily', '', 'Scheduled'],
        ['Medication', 'Hydroxyurea 400 mg PO suspension daily', 'HIGH-ALERT: chemotherapy agent', 'Scheduled'],
        ['Medication', '0.45% NaCl IV continuous 62 mL/hr', 'Maintenance fluids', 'Active'],
        ['Medication', 'Acetaminophen 205 mg PO q4h PRN pain 1–7', '', 'PRN'],
        ['Medication', 'Morphine 2.5 mg IV push q2h PRN pain 8–10', 'HIGH-ALERT opioid', 'PRN'],
        ['Medication', 'Albuterol 2.5 mg nebulised q4h PRN wheezing', '', 'PRN'],
        ['NEW ORDER', 'PRBCs 350 mL for Xavion Alexander — Unit #MS59937, O POS, ID M34JY89, DOB 03/08, exp 30 days', 'Rate 21 mL/hr. DUAL VERIFICATION required. Consent signed.', 'STAT'],
      ],
      labs: [
        ['Admission (yesterday)', 'Hemoglobin', '7.7 g/dL', '10.3–13.3', 'Critical', 'CRITICAL — significant anaemia'],
        ['Admission (yesterday)', 'Hematocrit', '29.2%', '31–43%', 'Low', ''],
        ['Admission (yesterday)', 'WBC', '10.3 K/µL', '4.5–13.5', 'Normal', ''],
        ['Admission (yesterday)', 'Platelets', '165 K/µL', '150–400', 'Normal', ''],
        ['Admission (yesterday)', 'INR', '1.3', '0.9–1.12', 'High', 'Slightly elevated'],
        ['Admission (yesterday)', 'Bilirubin Total', '4.9 mg/dL', '0.0–1.2', 'Critical', 'CRITICAL — haemolysis'],
        ['Admission (yesterday)', 'ALK Phos', '133 IU/L', '39–117', 'High', 'Elevated'],
        ['Admission (yesterday)', 'Type & Screen', 'A POS', '', 'Normal', 'Confirmed for blood product compatibility'],
        ['Today', 'CBC, PT/INR, CMP', 'Pending (due 0800)', '', 'Pending', ''],
      ],
      vitals: [{
        time: '04:30', hr: 120, bps: 90, bpd: 62, rr: 22, temp: '98.9',
        spo2: 97, pain: '8', fetal: 'N/A',
        note: 'Abdominal pain 8/10 on FACES scale. Abdominal guarding. Morphine given at 0435. Legs cool to touch.',
        by: 'Night shift RN'
      }],
      meds: [
        ['0.45% Sodium Chloride', '1 L at 62 mL/hr', 'IV continuous', 'Maintenance', 'Active', 'given', 'Maintenance IV fluid. Bolus completed 15 min ago.'],
        ['Morphine Sulfate', '2.5 mg', 'IV push', 'q2h PRN pain 8–10', 'PRN', 'given', 'HIGH-ALERT opioid. Last given 0710 for pain 8/10. Next available 0910.'],
        ['Acetaminophen', '205 mg suspension', 'PO', 'q4h PRN pain 1–7', 'PRN', 'given', 'Last given 0440.'],
        ['PRBCs', '350 mL (Unit #MS59937, O POS)', 'IV via Y-tubing', 'Rate 21 mL/hr', 'STAT', 'pending', 'HIGH-ALERT: DUAL VERIFICATION required before hanging. Check: patient ID, blood type, unit number, expiry, consent.'],
        ['Hydroxyurea', '400 mg suspension', 'PO daily', 'Daily', 'Scheduled', 'pending', 'HIGH-ALERT chemotherapy. Confirm dose and route.'],
        ['Folic Acid', '400 mcg suspension', 'PO daily', 'Daily', 'Scheduled', 'pending', ''],
        ['Albuterol', '2.5 mg nebulised', 'Inhalation', 'q4h PRN wheezing', 'PRN', 'pending', ''],
      ]
    })
  },
  ...
  // ── 5. SMALL BOWEL OBSTRUCTION ─────────────────────────────────────────
  {
    ...
    name: 'Small Bowel Obstruction — Elderly',
    focus: 'Medical-Surgical / Telemetry',
    level: 'Advanced',
    summary: '80-year-old female with DNR admitted for partial adhesive SBO. Nausea, vomiting, firm distended abdomen, glucose 286. Requires NGT insertion, Foley, IV fluids with KCl, and complex medication management including insulin sliding scale.',
    skills: ['NGT insertion', 'Abdominal assessment', 'Glucose management', 'HIGH-ALERT medications'],
    patient: patientTemplate({
      id: 'sbo-default', scenarioId: 'small_bowel_obstruction',
      firstName: 'Lucille', lastName: 'Boughman',
      age: '80', sex: 'Female', dob: '10/21', mrn: '51-25001',
      location: 'Telemetry Medical/Surgical Unit',
      diagnosis: 'Partial Adhesive Small Bowel Obstruction',
      acuity: 'Watch',
      allergies: 'Penicillin',
      codeStatus: 'Do Not Resuscitate (DNR)',
      specialty: 'Medical-Surgical / Telemetry',
      tags: ['SBO', 'DNR', 'HIGH-ALERT Insulin', 'HIGH-ALERT Morphine', 'NGT', 'HCT'],
      gestation: 'N/A',
      chiefComplaint: '1 week intermittent abdominal cramping, nausea, vomiting, and inability to tolerate PO',
      hpi: 'Lucille Boughman, 80-year-old female, was admitted overnight to med/surg after presenting to ED with a week of intermittent mid-abdominal cramping and diarrhoea. Three days of bloating, nausea, and vomiting — cannot tolerate PO including medications. Imaging confirmed partial adhesive SBO. Admission workup included abdominal CT and flat/upright abdominal X-rays.',
      background: 'Vitals at 0400: HR 100; RR 22; BP 132/88; SpO2 97% RA; T 100.9°F. NPO. Alert and oriented ×3. 20g double-lumen peripheral IV left AC infusing 0.9% NaCl at 167 mL/hr. Bowel sounds hyperactive RUQ and LUQ. Abdomen firm and distended. Last BM: 3 days ago. Vomited 300 mL yellow-green emesis at 0300 (ondansetron given). Voided 480 mL amber urine at 0400. Surgeon visited at 0700.',
      pastHistory: 'Diabetes Type II, Hypertension, Hyperlipidemia, Coronary Artery Disease, Endometriosis. Surgical history: TAH, appendectomy, cholecystectomy.',
      social: 'Worked as a nurse. Widowed. Lives independently. Son and daughter within 10 miles. DNR. Daughter Sandi = Power of Attorney.',
      familyContact: 'Daughter Sandi (POA) — contactable. Son nearby.',
      objectives: [
        'Conduct a morning nursing assessment of a patient with small bowel obstruction.',
        'Implement evidence-based treatment: NGT insertion, Foley catheter, IV fluids with KCl.',
        'Prioritise nursing interventions — glucose control, pain management, abdominal monitoring.',
        'Update the provider on patient condition and abnormal lab results using SBAR.',
      ],
      orders: [
        ['Monitoring', 'Continuous 5-lead ECG and SpO2 monitoring', '', 'Active'],
        ['Nursing', 'Vital signs every 2 hours', 'Notify: SBP<100 or >160; HR<60 or >110; RR<10 or >26; SpO2<90%; T>101°F', 'Active'],
        ['Nursing', 'NPO', '', 'Active'],
        ['Nursing', 'OOB as tolerated. IV access maintained (done).', '', 'Active'],
        ['Nursing', 'Monitor I/O every shift. Measure abdominal girth every 4 hours.', '', 'Active'],
        ['Nursing', 'Capillary blood glucose every 4 hours and PRN', 'Initiate hypoglycaemia protocol as needed', 'Active'],
        ['Respiratory', 'Titrate O2 to maintain SpO2 ≥ 94%', '', 'Active'],
        ['Imaging', 'CXR, Abdominal X-ray (erect and flat), CT abdomen with IV contrast — done', 'Results available in chart', 'Complete'],
        ['IV Fluids', '0.9% NaCl continuous at 167 mL/hr (running)', 'Current IV', 'Active'],
        ['Medication', 'Hydralazine 10 mg IV push q6h (hold if SBP < 100)', '', 'Scheduled'],
        ['Medication', 'Glargine insulin 15 units SQ once daily at bedtime', 'HIGH-ALERT', 'Scheduled'],
        ['Medication', 'Regular insulin per sliding scale SQ q4h', 'HIGH-ALERT', 'Active'],
        ['Medication', 'Ondansetron 4 mg IV push q8h PRN nausea/vomiting', '', 'PRN'],
        ['Medication', 'Morphine 2 mg IV push q2h PRN abdominal pain > 5/10', 'HIGH-ALERT opioid', 'PRN'],
        ['NEW ORDER', 'STOP 0.9% NaCl — START 0.9% NaCl with KCl 20 mEq at 167 mL/hr', 'HIGH-ALERT: dual verification. Continuous cardiac monitoring required.', 'STAT'],
        ['NEW ORDER', 'Insert NGT and connect to low intermittent suction', 'Measure abdominal girth before and 5 min after insertion', 'STAT'],
        ['NEW ORDER', 'Insert Foley catheter — note output', '', 'STAT'],
      ],
      labs: [
        ['Today 0600', 'Glucose', '286 mg/dL', '70–99', 'Critical', 'CRITICAL — sliding scale: >250 = 10 units Regular insulin'],
        ['Today 0600', 'Sodium', '132 mmol/L', '135–145', 'Low', 'Mild hyponatraemia'],
        ['Today 0600', 'Potassium', '3.0 mmol/L', '3.5–5.2', 'Critical', 'CRITICAL LOW — KCl ordered'],
        ['Today 0600', 'Lactate', '3.2 mmol/L', '<2.0', 'High', 'Elevated — possible ischaemia'],
        ['Today 0600', 'WBC', '13.4 K/µL', '5.0–10.0', 'High', 'Elevated — inflammatory response'],
        ['CT Abdomen', 'CT interpretation', 'Partial adhesive SBO with transition point at 2 bowel points', 'Normal', 'Abnormal', 'Dr. Magdalena Gonzalez, MD (Radiologist)'],
      ],
      vitals: [{
        time: '04:00', hr: 100, bps: 132, bpd: 88, rr: 22, temp: '100.9',
        spo2: 97, pain: '7', fetal: 'N/A',
        note: 'NPO. Abdomen firm and distended. Bowel sounds hyperactive. Vomited 300 mL at 0300. Periumbilical cramping. IV patent.',
        by: 'Night shift RN'
      }],
      meds: [
        ['0.9% NaCl', '1 L at 167 mL/hr', 'IV continuous', 'Continuous — STOP per new order', 'Active', 'hold', 'DISCONTINUE — replace with 0.9% NaCl + KCl 20 mEq per new order.'],
        ['0.9% NaCl + KCl 20 mEq', '1 L at 167 mL/hr', 'IV continuous', 'NEW ORDER', 'STAT', 'pending', 'HIGH-ALERT: Dual verification required. Continuous cardiac monitoring mandatory.'],
        ['Regular Insulin (sliding scale)', 'Per scale', 'SQ q4h', 'Current glucose 286 → 10 units', 'Active', 'pending', 'HIGH-ALERT. Check BG before each dose. Hypoglycaemia protocol available.'],
        ['Glargine Insulin', '15 units', 'SQ', 'Once daily at bedtime', 'Scheduled', 'pending', 'HIGH-ALERT. Do not confuse with Regular insulin.'],
        ['Morphine', '2 mg', 'IV push', 'q2h PRN pain > 5/10', 'PRN', 'pending', 'HIGH-ALERT opioid. Current pain 7/10.'],
        ['Hydralazine', '10 mg', 'IV push', 'q6h — hold if SBP < 100', 'Scheduled', 'pending', 'Current BP 132/88 — administer.'],
        ['Ondansetron', '4 mg', 'IV push', 'q8h PRN nausea', 'PRN', 'given', 'Given at 0300 for emesis.'],
      ]
    })
  },
  ...
  {
    id: 'pyelonephritis',
    name: 'Pyelonephritis with Anaphylaxis',
    focus: 'Emergency Department',
    level: 'Advanced',
    summary: '38-year-old female with pyelonephritis developing anaphylaxis during piperacillin/tazobactam infusion. Rapid deterioration: wheezing, hypotension, itchy throat. Requires immediate epinephrine IM STAT and SBAR escalation.',
    skills: ['Anaphylaxis recognition', 'Epinephrine IM', 'Antibiotic safety', 'SBAR escalation'],
    patient: patientTemplate({
      id: 'pyelo-default', scenarioId: 'pyelonephritis',
      firstName: 'Nadia', lastName: 'Carter',
      age: '38', sex: 'Female', dob: '2/28', mrn: '51-01001',
      location: 'Emergency Department',
      diagnosis: 'Pyelonephritis — Anaphylaxis during antibiotic infusion',
      acuity: 'Critical', allergies: 'No Known Allergies (on admission)',
      specialty: 'Emergency / Medical-Surgical',
      tags: ['Pyelonephritis', 'Anaphylaxis', 'HIGH-ALERT Epi', 'ED', 'HCT'],
      gestation: 'N/A',
      chiefComplaint: 'Right flank pain, dysuria, urinary frequency — progressed to anaphylaxis',
      hpi: 'Nadia Carter arrived to the ED 3 hours ago with generalised malaise, 5/10 right flank pain, dysuria, and worsening urinary frequency for 4 days. Treated at urgent care 3 days ago for UTI with TMP/SMX (completed full course). Worsening → pyelonephritis diagnosis. IV piperacillin/tazobactam overdue from pharmacy — you are initiating now. SCENARIO DEVELOPS: Patient develops anaphylaxis during infusion.',
      background: 'Vitals on arrival: HR 92; RR 16; BP 108/70; T 100.1°F; SpO2 97%; flank pain 5/10. IV D5W/0.9% NaCl at 125 mL/hr running. Labs (CBC, BMP, UA) drawn. Urinalysis shows nitrites positive, leukocyte esterase positive, cloudy, protein positive, blood positive.',
      pastHistory: 'Generalised Anxiety Disorder (escitalopram daily), Asthma (albuterol PRN MDI), Polycystic Ovary Syndrome (OCP daily).',
      social: 'Lives with fiancé Marcus. Works full-time as veterinary secretary. Sister April present in ED. Previous partner left suddenly 2 years ago — first panic attack followed.',
      familyContact: 'Sister April Young — in waiting room. Fiancé Marcus Williamson — contactable.',
      objectives: [
        'Perform a physical assessment for a patient with pyelonephritis.',
        'Initiate scheduled IV piperacillin/tazobactam safely.',
        'RECOGNISE anaphylaxis: wheezing, hypotension, itchy throat, cough, SpO2 drop.',
        'Immediately apply O2 via non-rebreather and STOP the infusion.',
        'Administer epinephrine 0.5 mg IM STAT and update the provider with SBAR.',
      ],
      orders: [
        ['Nursing', 'Vital signs every 2 hours or as needed', 'Notify: HR<50 or >100; SBP<90 or >130; RR<12 or >26; SpO2<90%; T>38°C; uncontrolled pain', 'Active'],
        ['IV', 'Insert peripheral IV and maintain access', 'Done — running D5W/0.9% NaCl', 'Active'],
        ['Diet', 'Clear liquid diet. Monitor I/O.', '', 'Active'],
        ['Lab', 'CBC, BMP, UA with reflex to culture — collected', '', 'Complete'],
        ['Medication', 'Piperacillin/Tazobactam 3.375g in 0.9% NaCl 100 mL — infuse over 30 min', 'INITIATING NOW — monitor for reaction', 'STAT'],
        ['Medication', 'D5W/0.9% NaCl 125 mL/hr continuous', 'Running', 'Active'],
        ['Medication', 'Acetaminophen 650 mg PO PRN q4h for mild/moderate pain or fever > 38°C', '', 'PRN'],
        ['Medication', 'Ketorolac 15 mg IV push PRN q6h — second line moderate pain', '', 'PRN'],
        ['Medication', 'Ondansetron 4 mg IV push PRN q6h for nausea', '', 'PRN'],
        ['Medication', 'Albuterol 2.5 mg nebulised PRN q4h for asthma', '', 'PRN'],
        ['ANAPHYLAXIS ORDER', 'STOP piperacillin/tazobactam infusion immediately', 'Anaphylaxis protocol', 'STAT'],
        ['ANAPHYLAXIS ORDER', 'Apply oxygen via non-rebreather mask', 'High-flow O2', 'STAT'],
        ['ANAPHYLAXIS ORDER', 'Epinephrine 0.5 mg IM STAT (1:1000, 0.5 mL)', 'HIGH-ALERT. Inject lateral thigh.', 'STAT'],
        ['ANAPHYLAXIS ORDER', 'Methylprednisolone 125 mg IV push (after epinephrine)', '', 'STAT'],
        ['ANAPHYLAXIS ORDER', 'Albuterol 2.5 mg nebulised for persistent wheezing', '', 'STAT'],
      ],
      labs: [
        ['Today 15:59', 'UA Colour', 'Yellow, Cloudy', 'Yellow, Clear', 'Abnormal', 'Consistent with infection'],
        ['Today 15:59', 'UA Protein', 'Positive', 'Negative', 'Abnormal', ''],
        ['Today 15:59', 'UA Blood', 'Positive', 'Negative', 'Abnormal', ''],
        ['Today 15:59', 'UA Nitrite', 'Positive', 'Negative', 'Abnormal', 'Gram-negative bacteriuria likely'],
        ['Today 15:59', 'UA Leukocyte Esterase', 'Positive', 'Negative', 'Abnormal', 'Active UTI/pyelo'],
        ['Today 15:59', 'UA pH', '5.2', '4.5–8', 'Normal', ''],
        ['Today', 'CBC, BMP, Urine Culture', 'Pending', '', 'Pending', 'Drawn; results pending'],
      ],
      vitals: [{
        time: '16:45 (pre-infusion)', hr: 92, bps: 108, bpd: 70, rr: 16, temp: '100.1',
        spo2: 97, pain: '5', fetal: 'N/A',
        note: 'Patient anxious but cooperative. Right CVA tenderness. No current wheezing. Starting piperacillin/tazobactam now.',
        by: 'ED RN'
      }],
      meds: [
        ['Piperacillin/Tazobactam', '3.375g / 100 mL NS', 'IV infusion', 'Over 30 min — INITIATING', 'STAT', 'pending', 'Monitor closely for 5–10 min after start for infusion reaction/anaphylaxis. STOP immediately if wheezing, throat tightness, BP drop, or urticaria.'],
        ['Epinephrine 1:1000', '0.5 mg (0.5 mL)', 'IM — lateral thigh', 'STAT for anaphylaxis', 'STAT', 'pending', 'HIGH-ALERT. For anaphylaxis only. Inject lateral mid-thigh. Repeat in 5–15 min if no improvement.'],
        ['Methylprednisolone', '125 mg', 'IV push', 'STAT after epinephrine', 'STAT', 'pending', 'Administer after epinephrine for anaphylaxis.'],
        ['Albuterol', '2.5 mg nebulised', 'Inhalation', 'STAT for persistent wheeze', 'STAT', 'pending', ''],
        ['Ondansetron', '4 mg', 'IV push', 'PRN nausea q6h', 'PRN', 'pending', ''],
        ['D5W / 0.9% NaCl', '125 mL/hr', 'IV continuous', 'Running', 'Active', 'given', ''],
      ]
    })
  },
  ...
  {
    id: 'hiv_shingles',
    name: 'HIV and Shingles: New Diagnosis',
    focus: 'Medical-Surgical',
    level: 'Intermediate',
    summary: '42-year-old bisexual woman admitted with shingles, found to be HIV-positive. CD4 342, viral load 524,304 copies/mL. Denial of diagnosis, therapeutic communication priorities, PPE (airborne + contact), IV acyclovir, and ART initiation.',
    skills: ['Airborne + Contact PPE', 'HIV education', 'Antiretroviral therapy', 'Therapeutic communication'],
    patient: patientTemplate({
      id: 'hiv-default', scenarioId: 'hiv_shingles',
      firstName: 'Tanisha', lastName: 'Reaves',
      age: '42', sex: 'Female', dob: '4/18', mrn: '51-05001',
      location: 'Medical/Surgical Unit',
      diagnosis: 'Shingles (Herpes Zoster) and HIV-1 — New Diagnosis',
      acuity: 'Watch',
      allergies: 'Shellfish (Anaphylaxis)',
      specialty: 'Medical-Surgical / Infectious Disease',
      tags: ['HIV', 'Shingles', 'Airborne', 'Contact', 'Allergy:Shellfish', 'HCT'],
      gestation: 'N/A',
      chiefComplaint: 'Painful vesicular rash — neck, back, chest. New HIV diagnosis.',
      hpi: 'Tanisha Reaves presented to the ED yesterday evening with a painful, itchy, vesicular rash on her neck that began 3 days prior. She also reported unintentional weight loss over the past month, lymphadenopathy, and fatigue she attributed to her anaemia. In the ED: IV fluid bolus given, IV acyclovir administered for confirmed shingles. HIV rapid screen positive — confirmed HIV-1. Transferred to Med-Surg at 0415 this morning. Infectious disease specialist just left 15 minutes ago.',
      background: 'Last vitals at 0425: BP 118/72, HR 89, RR 18, SpO2 99% RA, T 37.4°C (99.3°F). Rash has spread to back and chest since ED. Fatigue persists. 22g IV left wrist — saline locked. Labs ordered by ID specialist prior to ART initiation.',
      pastHistory: 'GERD, Uterine Fibroids, Iron Deficiency Anaemia.',
      social: 'Unemployed, actively seeking work. Lives with roommate Kiera. In relationship with Ryan (identifies as transgender male; Tanisha is bisexual). Several missed appointments noted in EMR.',
      familyContact: 'Roommate Kiera. Partner Ryan. Emergency contact on file.',
      objectives: [
        'Don appropriate PPE (gown, gloves, N95 respirator) BEFORE entering room.',
        'Conduct a focused nursing assessment: skin, cardiovascular, respiratory, pain, psychosocial.',
        'Address patient\'s denial, concerns, and emotional response to HIV diagnosis.',
        'Administer IV acyclovir for shingles and obtain labs prior to ART.',
        'Initiate bictegravir/emtricitabine/tenofovir alafenamide (ART) and provide education.',
      ],
      orders: [
        ['Precautions', 'Airborne AND Contact Precautions', 'Gown + gloves + N95 respirator REQUIRED before entering room', 'Active'],
        ['Nursing', 'Vital signs every 4 hours and as needed', 'Notify for changes in condition', 'Active'],
        ['IV', '22g IV saline locked left wrist — maintain access', '', 'Active'],
        ['Lab', 'Obtain labs prior to ART: CBC, CMP, CD4, HIV viral load, HLA-B, hepatitis panel', 'Draw from IV before first ART dose', 'STAT'],
        ['Medication', 'IV Acyclovir 850 mg in 0.9% NaCl 100 mL — over 1 hour', 'Antiviral for shingles', 'STAT'],
        ['Medication', 'Bictegravir 50 mg / Emtricitabine 200 mg / Tenofovir Alafenamide 25 mg PO once daily', 'ART — initiate after labs drawn', 'Scheduled'],
        ['Medication', 'Ferrous Sulfate 325 mg PO every other day', 'Home med — resume', 'Scheduled'],
        ['Medication', 'Famotidine 20 mg PO twice daily', 'Home med — GERD', 'Scheduled'],
        ['Medication', 'Acetaminophen 650 mg PO PRN pain', '', 'PRN'],
        ['Nursing', 'Provide patient education on: HIV diagnosis, ART adherence, transmission, shingles', 'Document learner response', 'Active'],
        ['Procedure', 'Doff PPE (gown, gloves, N95) and perform hand hygiene BEFORE leaving room', '', 'Active'],
      ],
      labs: [
        ['Yesterday 22:21', 'HIV 1&2 Rapid Screen', 'Positive', 'Negative', 'Critical', 'CRITICAL — confirmed HIV-1'],
        ['Yesterday 23:03', 'HIV 1&2 Ag/Ab', 'HIV-1 confirmed', 'Negative', 'Critical', ''],
        ['Yesterday 23:03', 'CD4 T-cell count', '342 cells/µL', '500–2000/µL', 'Low', 'Immunosuppressed — shingles consistent'],
        ['Yesterday 23:03', 'HIV RNA (Viral Load)', '524,304 copies/mL', 'Undetectable', 'Critical', 'CRITICAL — very high viral load'],
        ['Yesterday 22:21', 'Hemoglobin', '11 g/dL', '12–16 g/dL (F)', 'Low', 'Known iron deficiency anaemia'],
        ['Yesterday 22:21', 'WBC', '6.8 K/µL', '5.0–10.0', 'Normal', ''],
        ['Yesterday 22:21', 'ALT', '69 IU/L', '0–32 IU/L', 'High', 'Elevated — hepatic monitoring needed on ART'],
        ['Yesterday 22:21', 'AST', '58 IU/L', '0–40 IU/L', 'High', ''],
        ['Today', 'HLA-B', 'Pending', 'Negative', 'Pending', 'Required before abacavir use — not applicable to this regimen but ordered per protocol'],
      ],
      vitals: [{
        time: '04:25', hr: 89, bps: 118, bpd: 72, rr: 18, temp: '37.4',
        spo2: 99, pain: '5', fetal: 'N/A',
        note: 'Rash spread to back and chest. Vesicular. Patient appears tired. Denying HIV diagnosis on nursing contact. PPE required.',
        by: 'Night shift RN'
      }],
      meds: [
        ['IV Acyclovir', '850 mg / 100 mL NS', 'IV infusion', 'Over 1 hour — STAT', 'STAT', 'pending', 'Antiviral for shingles. Administer before ART. Monitor renal function.'],
        ['Bictegravir/Emtricitabine/Tenofovir Alafenamide', '50/200/25 mg', 'PO daily', 'Once daily — after labs drawn', 'Scheduled', 'pending', 'ART regimen. Complete lab draw FIRST. Educate patient on adherence, side effects, and transmission.'],
        ['Ferrous Sulfate', '325 mg', 'PO', 'Every other day', 'Scheduled', 'pending', 'Home med for iron deficiency anaemia.'],
        ['Famotidine', '20 mg', 'PO', 'Twice daily', 'Scheduled', 'pending', 'For GERD.'],
        ['Acetaminophen', '650 mg', 'PO', 'PRN pain', 'PRN', 'pending', 'Do NOT give ketorolac or NSAIDs — monitor renal function on ART.'],
      ]
    })
  },
  ...
  // ── 8. OPIOID MANAGEMENT ───────────────────────────────────────────────
  {
    id: 'opioid_management',
    name: 'Post-Op Pain: Opioid Toxicity',
    focus: 'Medical-Surgical',
    level: 'Advanced',
    summary: '54-year-old male, POD 2 after total left hip arthroplasty, complaining of 10/10 pain. Develops opioid toxicity after escalated hydromorphone — drowsy, slurred speech. Requires O2, naloxone 0.4 mg IV, wound care, and SBAR.',
    skills: ['Opioid safety', 'Naloxone administration', 'Respiratory monitoring', 'Wound care'],
    patient: patientTemplate({
      id: 'opioid-default', scenarioId: 'opioid_management',
      firstName: 'Richard', lastName: 'Morton',
      age: '54', sex: 'Male', dob: '04/28', mrn: '51-61001',
      location: 'Medical/Surgical Unit',
      diagnosis: 'Post-Op Total Left Hip Arthroplasty POD 2 — Opioid Toxicity',
      acuity: 'Critical', allergies: 'NSAIDs',
      specialty: 'Surgical / Medical-Surgical',
      tags: ['Post-op', 'HIGH-ALERT Opioid', 'Naloxone', 'Allergy:NSAIDs', 'HCT'],
      gestation: 'N/A',
      chiefComplaint: 'Pain 10/10 left hip — now drowsy, slurred speech',
      hpi: 'Richard Morton is a 54-year-old male, POD 2 from total left hip arthroplasty due to work-related joint deterioration. Surgery uncomplicated. Frequently complaining of 10/10 pain despite hydromorphone 1 mg IV q3h. Night nurse increased hydromorphone to 2 mg — given 30 minutes ago. Patient is now drowsy with slurred speech. Daughter Jenny at bedside — asked her to bring prescription pain pills from home (refused by staff). SCENARIO: Opioid toxicity develops.',
      background: 'Vitals 30 min ago: HR 98; RR 18; BP 146/82; SpO2 96% RA; T 98.2°F. Normal saline IV lock left arm, soft and patent. Left hip wound: clean dry intact occlusive dressing. Well-approximated incision, sutures intact, small amount serosanguinous drainage. Dressing change due today.',
      pastHistory: 'Chronic low back and left hip pain (5 years — fall from 15-foot ladder while firefighting). Hypertension, Hyperlipidaemia, Type 2 Diabetes.',
      social: 'Retired firefighter. Daughter Jenny — next of kin at bedside. Denies alcohol, tobacco, illicit drugs. Home opioid use: hydrocodone/acetaminophen 7.5/325 PRN.',
      familyContact: 'Daughter Jenny Morton — at bedside.',
      objectives: [
        'Conduct a focused assessment: drowsiness, slurred speech, pupil reactivity, respiratory rate.',
        'Identify opioid toxicity: SpO2 drop, RR < 12, drowsiness, miosis, slurred speech.',
        'Apply supplemental O2 per provider order.',
        'Administer naloxone 0.4 mg IV push per provider order.',
        'Perform wound assessment and dressing change. SBAR to provider.',
      ],
      orders: [
        ['Nursing', 'Normal saline IV lock', 'Left arm — patent', 'Active'],
        ['Monitoring', 'Continuous SpO2 and 5-lead ECG monitoring', '', 'Active'],
        ['Nursing', 'Vital signs every 4 hours or as needed', 'Notify for changes in condition', 'Active'],
        ['Nursing', 'Check capillary blood glucose PRN for hypo/hyperglycaemia signs', '', 'Active'],
        ['Diet', 'Diabetic diet. Activity: weight-bearing as tolerated with walker.', '', 'Active'],
        ['Nursing', 'Apply compression stockings', '', 'Active'],
        ['Nursing', 'Cleanse left lateral hip incision with NS swabs and apply occlusive dressing daily', '', 'Active'],
        ['Respiratory', 'Incentive spirometer × 5 every 1 hour while awake', '', 'Active'],
        ['Respiratory', 'Apply and titrate O2 as needed to maintain SpO2 > 92%', '', 'Active'],
        ['Medication', 'Lisinopril 20 mg PO daily', '', 'Scheduled'],
        ['Medication', 'Metformin 500 mg PO BID', '', 'Scheduled'],
        ['Medication', 'Simvastatin 40 mg PO daily', '', 'Scheduled'],
        ['Medication', 'Enoxaparin 30 mg SQ q12h', 'DVT prophylaxis — HIGH-ALERT LMWH', 'Scheduled'],
        ['Medication', 'Hydromorphone 2 mg IV push q3h PRN pain 7–10', 'HIGH-ALERT opioid — HOLD pending toxicity assessment', 'PRN'],
        ['Medication', 'Hydrocodone/Acetaminophen 7.5/325 mg PO q6h PRN pain 5–7', 'HOME med — only if awake and tolerating PO', 'PRN'],
        ['Medication', 'Acetaminophen 500 mg PO q6h PRN pain 1–4', '', 'PRN'],
        ['Medication', 'Docusate sodium 50 mg PO q12h PRN constipation', '', 'PRN'],
        ['TOXICITY ORDER', 'Naloxone 0.4 mg IV push — STAT for respiratory depression from opioid toxicity', 'Repeat in 3 minutes if RR < 12. Notify provider after administration.', 'STAT'],
        ['TOXICITY LAB', 'Obtain blood sample for serum acetaminophen level', 'Ordered by provider after naloxone given', 'STAT'],
      ],
      labs: [
        ['Today (post-toxicity)', 'Serum Acetaminophen Level', 'Pending', 'Therapeutic <20 mcg/mL', 'Pending', 'Ordered after naloxone — patient may have taken home acetaminophen'],
        ['Admission', 'Glucose (capillary)', '128 mg/dL', '70–110', 'High', 'Known T2DM'],
        ['Admission', 'HbA1c (prior)', '7.2%', '<5.7%', 'High', 'Known DM2'],
      ],
      vitals: [{
        time: '07:00 (pre-deterioration)', hr: 98, bps: 146, bpd: 82, rr: 18, temp: '98.2',
        spo2: 96, pain: '10', fetal: 'N/A',
        note: 'Patient drowsy. Slurred speech. Daughter at bedside. Hydromorphone 2 mg given 30 min ago. MONITOR for toxicity.',
        by: 'Night shift RN'
      }],
      meds: [
        ['Naloxone', '0.4 mg', 'IV push', 'STAT — opioid toxicity', 'STAT', 'pending', 'Opioid reversal agent. Administer immediately for RR < 12, SpO2 drop, or unresponsiveness. Apply O2 FIRST. Notify provider. Repeat in 3 min if no improvement.'],
        ['Hydromorphone', '2 mg', 'IV push', 'q3h PRN pain 7–10', 'PRN', 'hold', 'HIGH-ALERT. HOLD — opioid toxicity in progress. Do not administer until toxicity resolved and provider clears.'],
        ['Enoxaparin', '30 mg / 0.3 mL', 'SQ injection', 'q12h', 'Scheduled', 'pending', 'HIGH-ALERT LMWH — DVT prophylaxis. Inject abdomen at 90°.'],
        ['Lisinopril', '20 mg', 'PO daily', 'Daily', 'Scheduled', 'pending', 'Hold if SBP < 100 or symptomatic hypotension.'],
        ['Metformin', '500 mg', 'PO BID', 'Twice daily', 'Scheduled', 'pending', ''],
        ['Simvastatin', '40 mg', 'PO daily', 'Daily', 'Scheduled', 'pending', 'Note: ALLERGY to NSAIDs — no ibuprofen or ketorolac.'],
      ]
    })
  },
  ...
  {
    id: 'preterm_labor',
    name: 'Preterm Labor at 26 Weeks',
    focus: 'Obstetrics / Labor & Delivery',
    level: 'Advanced',
    summary: '38-year-old G3P1, 26 weeks gestation, contractions every 3 minutes, cervix 4 cm dilated. Requires magnesium sulfate loading dose (HIGH-ALERT), betamethasone, nifedipine, indomethacin, and penicillin G. Continuous CTG monitoring.',
    skills: ['HIGH-ALERT Magnesium', 'Tocolysis', 'Fetal monitoring', 'Preterm labor bundle'],
    patient: patientTemplate({
      id: 'preterm-default', scenarioId: 'preterm_labor',
      firstName: 'Hana', lastName: 'Kamiya-Johnson',
      age: '38', sex: 'Female', dob: '08/12', mrn: '51-74001',
      location: 'Labor & Delivery Unit',
      diagnosis: 'Preterm Labor — 26 Weeks Gestation',
      acuity: 'Urgent', allergies: 'No Known Allergies',
      specialty: 'Obstetrics / L&D',
      tags: ['OB', 'Preterm', 'HIGH-ALERT MgSO4', 'CTG', 'HCT'],
      gestation: 'G3P1, 26 weeks gestation',
      chiefComplaint: 'Contractions every 3 minutes for 3 hours',
      hpi: 'Hana Kamiya-Johnson is a 38-year-old G3P1 at 26 weeks gestation. Presented to L&D with moderate contractions 3 minutes apart for the past 3 hours. Admitted with diagnosis of preterm labor. Wife Liz is at the bedside and very concerned.',
      background: 'Triage vitals: HR 86; RR 16; T 98.5°F (36.9°C); SpO2 99% RA; BP 114/72 mmHg (right arm, sitting). Two 18g saline locks in left wrist and left AC. Urine sample and GBS culture sent to lab. Continuous external CTG in place: FHR 140 bpm, moderate variability, accelerations noted during contractions. Contractions every 3 minutes. Cervix 4 cm dilated, 70% effaced, +1 station, vertex presentation. Membranes intact. No vaginal bleeding. Dr. Robinson (hospitalist OB/GYN) has entered admission orders.',
      pastHistory: 'No chronic conditions. Conceived via IVF. Routine prenatal care. 20-week anatomy scan normal. Negative gestational diabetes screen at 24 weeks. History: 1 miscarriage 5 years ago. Son Parker born prematurely at 28 weeks — has cerebral palsy.',
      social: 'Married to Liz Kamiya-Johnson. 3-year-old son Parker (cerebral palsy). Wife at bedside.',
      familyContact: 'Wife Liz Kamiya-Johnson — at bedside.',
      objectives: [
        'Perform a focused antepartum nursing assessment for a patient in preterm labor.',
        'Implement evidence-based nursing interventions for preterm labor.',
        'Safely administer magnesium sulfate loading dose with dual verification.',
        'Monitor fetal and maternal response to tocolytic therapy.',
        'Communicate patient and fetal condition to the provider using SBAR.',
      ],
      orders: [
        ['Nursing', 'Continuous external cardiotocography (CTG) monitoring', '', 'Active'],
        ['Nursing', 'Continuous maternal cardiorespiratory monitoring', '', 'Active'],
        ['IV', 'Establish and maintain IV access (done — 2 lines)', '', 'Active'],
        ['Nursing', 'Vital signs every 1 hour or more frequently as needed', '', 'Active'],
        ['Nursing', 'Strict I/O, DTRs, clonus, LOC, respiratory assessment every 1 hour while on MgSO4', '', 'Active'],
        ['Nursing', 'Sterile vaginal exams every 2 hours or as needed', '', 'Active'],
        ['Diet', 'Clear fluids and ice chips PO as tolerated. Activity as tolerated.', '', 'Active'],
        ['Lab', 'CBC, CMP', 'Draw from IV', 'Active'],
        ['Medication', 'Magnesium Sulfate LOADING: 4 g in 100 mL NS IV over 30 min (200 mL/hr)', 'HIGH-ALERT. Dual verification required. Have calcium gluconate 1 g IV at bedside for toxicity.', 'STAT'],
        ['Medication', 'Magnesium Sulfate MAINTENANCE: 1 g/hr continuous IV after loading dose', 'HIGH-ALERT. Monitor: RR (must be ≥ 12), DTRs, urine output (must be ≥ 30 mL/hr).', 'Scheduled'],
        ['Medication', 'Betamethasone 12 mg IM — Repeat × 1 in 24 hours', 'For foetal lung maturity', 'STAT'],
        ['Medication', 'Nifedipine 30 mg PO LOADING — then 10 mg PO q8h × 48 hours', 'Tocolytic', 'STAT'],
        ['Medication', 'Indomethacin 50 mg PO LOADING — then 25 mg PO q6h × 48 hours', 'Tocolytic', 'STAT'],
        ['Medication', 'Penicillin G LOADING: 5 million units in 100 mL NS IV over 1 hour', 'GBS prophylaxis', 'STAT'],
        ['Medication', 'Penicillin G MAINTENANCE: 2.5 million units in 50 mL NS IV q4h after loading dose', 'GBS prophylaxis', 'Scheduled'],
        ['Medication', 'Calcium Gluconate 1 g IV push over 3–5 min PRN magnesium toxicity', 'MgSO4 antidote — keep at bedside', 'PRN'],
        ['Consult', 'Neonatology — notified of potential preterm delivery', '', 'Active'],
      ],
      labs: [
        ['Triage', 'GBS Culture', 'Pending', 'Negative', 'Pending', 'Results in 48–72 hours'],
        ['Triage', 'Urinalysis', 'Pending', 'Normal', 'Pending', ''],
        ['Today', 'CBC, CMP', 'Pending', '', 'Pending', 'Draw with IV'],
        ['CTG', 'FHR', '140 bpm — moderate variability, accelerations with contractions', '110–160 bpm with moderate variability', 'Normal', 'Reassuring pattern'],
        ['Cervical exam', 'Cervical dilation', '4 cm, 70% effaced, +1 station', 'Closed', 'Abnormal', 'Active preterm labor'],
      ],
      vitals: [{
        time: '16:00', hr: 86, bps: 114, bpd: 72, rr: 16, temp: '98.5',
        spo2: 99, pain: '4', fetal: 'FHR 140',
        note: 'Contractions every 3 minutes. Moderate intensity. Patient anxious. Wife Liz at bedside. 2 IVs patent.',
        by: 'Triage RN'
      }],
      meds: [
        ['Magnesium Sulfate Loading', '4 g / 100 mL NS', 'IV over 30 min (200 mL/hr)', 'STAT × 1', 'STAT', 'pending', 'HIGH-ALERT. DUAL VERIFICATION required. Monitor: RR must be ≥12; DTRs must be present; urine output must be ≥30 mL/hr. ANTIDOTE: Calcium Gluconate 1 g IV at bedside.'],
        ['Magnesium Sulfate Maintenance', '1 g/hr', 'IV continuous', 'After loading dose', 'Scheduled', 'pending', 'HIGH-ALERT. Toxicity signs: loss of DTRs, RR<12, hypotension. STOP and give calcium gluconate if toxicity suspected.'],
        ['Betamethasone', '12 mg', 'IM', 'Now × 1; repeat in 24 hours', 'STAT', 'pending', 'Corticosteroid for foetal lung maturation. Inject deep IM.'],
        ['Nifedipine', '30 mg', 'PO', 'Loading dose now', 'STAT', 'pending', 'Tocolytic — calcium channel blocker. Monitor BP closely. Hold if SBP < 90.'],
        ['Indomethacin', '50 mg', 'PO', 'Loading dose now', 'STAT', 'pending', 'Tocolytic — NSAID. Stop after 48 hours. Monitor foetal ductal flow.'],
        ['Penicillin G', '5 million units / 100 mL NS', 'IV over 1 hour', 'Loading dose', 'STAT', 'pending', 'GBS prophylaxis. No penicillin allergy documented.'],
        ['Calcium Gluconate', '1 g / 10 mL (10%)', 'IV push over 3–5 min', 'PRN magnesium toxicity only', 'PRN', 'pending', 'MgSO4 antidote — keep at bedside during magnesium infusion.'],
      ]
    })
  },
 
  // ── 10. ANEMIA / BLOOD TRANSFUSION REACTION ────────────────────────────
  {
    id: 'anemia_taco',
    name: 'Anemia: Blood Transfusion Reaction (TACO)',
    focus: 'Intermediate Care Unit',
    level: 'Advanced',
    summary: '85-year-old female receiving second PRBC transfusion for anaemia. Develops TACO (Transfusion-Associated Circulatory Overload) — hypoxia, tachycardia, hypertension, shortness of breath. Requires immediate protocol activation, furosemide IV, and SBAR.',
    skills: ['Transfusion reaction recognition', 'TACO management', 'Furosemide IV', 'SBAR escalation'],
    patient: patientTemplate({
      id: 'anemia-default', scenarioId: 'anemia_taco',
      firstName: 'Geraldine', lastName: 'Larson',
      age: '85', sex: 'Female', dob: '05/12', mrn: '51-62001',
      location: 'Intermediate Care Unit',
      diagnosis: 'Anaemia — Blood Transfusion Reaction (TACO)',
      acuity: 'Critical', allergies: 'No Known Allergies',
      specialty: 'Medical / Intermediate Care',
      tags: ['Anaemia', 'TACO', 'HIGH-ALERT Blood Xfusion', 'HIGH-ALERT Furosemide', 'Telemetry', 'HCT'],
      gestation: 'N/A',
      chiefComplaint: 'Heavy epistaxis, anaemia — second PRBC transfusion in progress',
      hpi: 'Geraldine Larson, 85-year-old female, admitted to the ICU yesterday for anaemia (Hgb 6 g/dL) and supra-therapeutic INR (4.8). Received vitamin K 10 mg, 4F-PCC 1500 units, and first PRBC unit yesterday — tolerated well. Today Hgb 7 g/dL; second PRBC unit initiated 30 minutes ago by night shift nurse per protocol. SCENARIO DEVELOPS: Patient develops TACO (Transfusion-Associated Circulatory Overload) — hypoxia, ↑ HR, ↑ BP, shortness of breath, increased oedema.',
      background: 'Night shift vitals 15 minutes ago: HR 72; RR 16; BP 136/84; T 98.2°F; SpO2 96% on 2L NC. 18g double-lumen IV left AC infusing 1 unit PRBCs over 2 hours. Site soft and patent. Warfarin discontinued on admission.',
      pastHistory: 'Permanent atrial fibrillation, Hypertension, Congestive Heart Failure.',
      social: 'Reports significant financial constraints. Lives alone in the community. Difficulty managing chronic illnesses — missed PCP appointment and PT/INR lab last week (could not afford bus fare). Taking: furosemide 20 mg PO daily, enalapril 10 mg PO BID, carvedilol 12.5 mg PO BID. Warfarin 7.5 mg PO daily — discontinued on admission.',
      familyContact: 'No family noted — financial and social concerns. Social work consult recommended.',
      objectives: [
        'Assess a patient with anaemia receiving a blood transfusion.',
        'RECOGNISE TACO: hypoxia, ↑ HR, ↑ BP, SOB, ↑ oedema.',
        'Immediately raise HOB to Fowler\'s, increase O2 (4L NC), and STOP PRBC transfusion.',
        'Re-verify blood transfusion (patient ID, unit number, blood type) per protocol.',
        'Administer furosemide 20 mg IV push. Obtain BNP and chest X-ray. SBAR to provider.',
      ],
      orders: [
        ['Nursing', 'Vital signs with O2 sat per blood transfusion protocol', 'Before start; after 15 min; after 30 min; q1h until 1h post-transfusion', 'Active'],
        ['Nursing', 'Monitor I/O. Blood transfusion protocol active.', '', 'Active'],
        ['Lab', 'PT/INR, CBC, CMP, BNP — daily (today\'s drawn)', 'Results available', 'Complete'],
        ['Medication', 'Furosemide 20 mg PO daily (home med)', 'Home dose — hold while TACO resolving', 'Hold'],
        ['Medication', 'Enalapril 10 mg PO BID (home med)', '', 'Scheduled'],
        ['Medication', 'Carvedilol 12.5 mg PO BID (home med)', '', 'Scheduled'],
        ['TACO ORDER', 'STOP PRBC transfusion immediately', 'TACO protocol', 'STAT'],
        ['TACO ORDER', 'Raise head of bed to Fowler\'s or sitting position', '', 'STAT'],
        ['TACO ORDER', 'Increase O2 to 4L via nasal cannula', '', 'STAT'],
        ['TACO ORDER', 'Start 0.9% NS at KVO (25 mL/hr) — DO NOT use blood tubing', '', 'STAT'],
        ['TACO ORDER', 'Re-verify blood transfusion per protocol: patient ID, unit, blood type, ABO', '', 'STAT'],
        ['TACO ORDER', 'Furosemide 20 mg IV push NOW', 'HIGH-ALERT — diuretic. Monitor BP and SpO2 closely.', 'STAT'],
        ['TACO ORDER', 'Obtain chest X-ray', '', 'STAT'],
        ['TACO ORDER', 'Obtain blood sample for BNP', '', 'STAT'],
      ],
      labs: [
        ['Yesterday', 'Hemoglobin', '6 g/dL', '12–16 (F)', 'Critical', 'CRITICAL — transfusion indicated'],
        ['Yesterday', 'INR', '4.8', '1–2', 'Critical', 'CRITICAL — supratherapeutic. Warfarin discontinued.'],
        ['Yesterday', 'BNP', '410 pg/mL', '<100 pg/mL', 'High', 'Elevated — CHF baseline'],
        ['Today', 'Hemoglobin', '7 g/dL', '12–16 (F)', 'Low', 'Post-first-unit improvement'],
        ['Today', 'INR', '2.7', '1–2', 'High', 'Trending down'],
        ['Today', 'BNP', '413 pg/mL', '<100 pg/mL', 'High', 'Slight increase from yesterday — watch for TACO'],
        ['Today', 'Creatinine', '0.84 mg/dL', '0.57–1.00', 'Normal', ''],
        ['Today', 'BNP (post-reaction)', 'Pending (new order)', '<100 pg/mL', 'Pending', 'Ordered per TACO protocol'],
        ['Today', 'CXR (post-reaction)', 'Pending (new order)', 'Normal', 'Pending', 'Ordered per TACO protocol'],
      ],
      vitals: [{
        time: '07:00 (pre-TACO)', hr: 72, bps: 136, bpd: 84, rr: 16, temp: '98.2',
        spo2: 96, pain: '0', fetal: 'N/A',
        note: 'SpO2 96% on 2L NC. Resting. PRBCs infusing × 30 min. Monitor closely — CHF and high BNP.',
        by: 'Night shift RN'
      }],
      meds: [
        ['PRBCs', '1 unit (≈ 350 mL)', 'IV via 18g double-lumen', 'Over 2 hours — STOP per TACO order', 'Active', 'hold', 'STOP transfusion immediately for TACO. Clamp blood tubing. Start NS at KVO.'],
        ['Furosemide', '20 mg', 'IV push', 'STAT — TACO protocol', 'STAT', 'pending', 'HIGH-ALERT diuretic. Administer IV push slowly. Monitor BP and urine output.'],
        ['0.9% Sodium Chloride', 'KVO 25 mL/hr', 'IV — new tubing (not blood tubing)', 'Continuous after stopping PRBCs', 'STAT', 'pending', 'DO NOT run through blood tubing. Insert new IV line.'],
        ['Furosemide', '20 mg PO daily', 'PO', 'Home dose — HOLD during TACO', 'Scheduled', 'hold', 'Resume once TACO resolved and fluid status stabilised.'],
        ['Enalapril', '10 mg', 'PO BID', 'Twice daily', 'Scheduled', 'pending', 'Hold if SBP < 100.'],
        ['Carvedilol', '12.5 mg', 'PO BID', 'Twice daily', 'Scheduled', 'pending', 'Monitor HR and BP before administration.'],
      ]
    })
  },
  ...
  {
    id: 'anxiety_mhc',
    name: 'Anxiety — Mental Health Clinic',
    focus: 'Mental Health / Outpatient',
    level: 'Beginner (Fundamentals)',
    summary: '49-year-old male presenting to a mental health clinic for the first time. Reports anxiety, chest tightness, and difficulty managing at work. History of hypertension. Requires patient identification, vital signs, EHR review, and therapeutic communication.',
    skills: ['Patient identification', 'Mental health assessment', 'Vital signs', 'Therapeutic communication'],
    patient: patientTemplate({
      id: 'anxiety-default', scenarioId: 'anxiety_mhc',
      firstName: 'Brandon', lastName: 'Daniels',
      age: '49', sex: 'Male', dob: '11/01', mrn: '51-96001',
      location: 'UbiSim Mental Health Clinic',
      diagnosis: 'Generalised Anxiety Disorder — New Presentation',
      acuity: 'Stable', allergies: 'No Known Drug Allergies',
      specialty: 'Mental Health / Outpatient',
      tags: ['Anxiety', 'Mental Health', 'Outpatient', 'HCT'],
      gestation: 'N/A',
      chiefComplaint: 'Anxiety, chest tightness, difficulty managing at work — first clinic visit',
      hpi: 'Brandon Daniels, a 49-year-old male, presents to the mental health clinic for the first time. He reports increasing anxiety and chest tightness over the past several months. He has been struggling to manage his workload and relationships at work. He decided to seek help after his wife expressed concern about his mood and sleep.',
      background: 'Referred by primary care provider. Vital signs not yet obtained on this encounter.',
      pastHistory: 'Hypertension (managed with lisinopril). No prior mental health diagnoses.',
      social: 'Married. Employed full-time. Wife supportive. No reported substance use.',
      familyContact: 'Wife — not present today. Contactable.',
      objectives: [
        'Verify patient ID using two identifiers (NPS Goal).',
        'Review the EHR and provider orders.',
        'Obtain complete vital signs (HR, RR, BP, Temperature).',
        'Perform a focused mental health assessment using therapeutic communication.',
        'Document findings and report to the mental health provider.',
      ],
      orders: [
        ['Nursing', 'Verify patient identity with two identifiers', 'National Patient Safety Goal', 'Active'],
        ['Nursing', 'Review EHR and provider orders', '', 'Active'],
        ['Nursing', 'Obtain vital signs: HR, RR, BP, Temperature', 'Baseline assessment', 'Active'],
        ['Nursing', 'Perform mental health assessment', 'Anxiety screening (GAD-7), mood, sleep, support system', 'Active'],
        ['Medication', 'Lisinopril 10 mg PO daily (home med)', 'For hypertension', 'Scheduled'],
      ],
      labs: [
        ['Today', 'Vital Signs', 'Pending', '', 'Pending', 'Not yet obtained on this encounter'],
        ['Today', 'GAD-7 Anxiety Screening', 'Pending', 'Score < 5 = minimal', 'Pending', 'Complete with patient during visit'],
      ],
      vitals: [],
      meds: [
        ['Lisinopril', '10 mg', 'PO daily', 'Daily', 'Scheduled', 'pending', 'Home medication for hypertension.'],
      ]
    })
  },
  ...
  {
    id: 'depression_mhc',
    name: 'Depression — Mental Health Clinic',
    focus: 'Mental Health / Outpatient',
    level: 'Beginner (Fundamentals)',
    summary: '26-year-old female presenting to a mental health clinic for the first time with low mood, fatigue, and social withdrawal. No prior mental health diagnoses. PHQ-9 administration, therapeutic communication, and provider notification.',
    skills: ['PHQ-9 screening', 'Therapeutic communication', 'Safety assessment', 'SI screening'],
    patient: patientTemplate({
      id: 'depression-default', scenarioId: 'depression_mhc',
      firstName: 'Angela', lastName: 'Harrison',
      age: '26', sex: 'Female', dob: '06/30', mrn: '51-68001',
      location: 'UbiSim Mental Health Clinic',
      diagnosis: 'Depression — New Presentation',
      acuity: 'Stable', allergies: 'No Known Drug Allergies',
      specialty: 'Mental Health / Outpatient',
      tags: ['Depression', 'Mental Health', 'PHQ-9', 'SI screening', 'HCT'],
      gestation: 'N/A',
      chiefComplaint: 'Low mood, fatigue, social withdrawal — first clinic visit',
      hpi: 'Angela Harrison, a 26-year-old female, presents to the mental health clinic for the first time. She reports persistent low mood for the past 2 months, fatigue, loss of interest in activities she used to enjoy, and withdrawal from friends and family. She has been missing work. Her sister convinced her to seek help.',
      background: 'No prior mental health diagnoses. Vital signs not yet obtained on this encounter.',
      pastHistory: 'No chronic illnesses. No prior mental health diagnoses.',
      social: 'Single. Lives alone. Works as a graphic designer. Sister present in clinic waiting room.',
      familyContact: 'Sister — in waiting room.',
      objectives: [
        'Verify patient ID using two identifiers.',
        'Review the EHR and provider orders.',
        'Obtain vital signs: HR, RR, BP, Temperature.',
        'Administer PHQ-9 depression screening during visit.',
        'Conduct a safety assessment: screen for suicidal ideation, plan, and intent.',
        'Provide therapeutic communication and non-judgemental support.',
      ],
      orders: [
        ['Nursing', 'Verify patient identity with two identifiers', 'National Patient Safety Goal', 'Active'],
        ['Nursing', 'Review EHR and provider orders', '', 'Active'],
        ['Nursing', 'Obtain vital signs: HR, RR, BP, Temperature', 'Baseline assessment', 'Active'],
        ['Nursing', 'Administer PHQ-9 screening tool during visit', 'Score and document', 'Active'],
        ['Nursing', 'Safety assessment — screen for SI, HI, plan, access to means', '', 'Active'],
        ['Nursing', 'Notify provider of assessment findings and PHQ-9 score', '', 'Active'],
      ],
      labs: [
        ['Today', 'Vital Signs', 'Pending', '', 'Pending', 'Not yet obtained'],
        ['Today', 'PHQ-9 Score', 'Pending', 'Score 0–4 = minimal; Score ≥10 = moderate-severe', 'Pending', 'Administer during nursing visit'],
      ],
      vitals: [],
      meds: []
    })
  ...
  {
    id: 'mpox',
    name: 'Mpox — Urgent Care',
    focus: 'Infectious Disease / Urgent Care',
    level: 'Intermediate',
    summary: '45-year-old male presenting with generalised vesicular rash after returning from Africa. Partner confirmed mpox. Requires airborne + contact PPE, social history, specimen collection, ibuprofen, and case reporting education.',
    skills: ['Airborne + Contact PPE', 'Specimen collection', 'Stigma-sensitive communication', 'Infectious disease reporting'],
    patient: patientTemplate({
      id: 'mpox-default', scenarioId: 'mpox',
      firstName: 'Jeremy', lastName: 'Anderson',
      age: '45', sex: 'Male', dob: '09/24', mrn: '51-04001',
      location: 'Urgent Care Clinic',
      diagnosis: 'Suspected Mpox — Airborne and Contact Precautions',
      acuity: 'Urgent',
      allergies: 'No Known Allergies',
      specialty: 'Infectious Disease / Urgent Care',
      tags: ['Mpox', 'Airborne', 'Contact', 'Infectious Disease', 'Case reporting', 'HCT'],
      gestation: 'N/A',
      chiefComplaint: 'Generalised rash and throat pain — returned from Africa 3 days ago',
      hpi: 'Jeremy Anderson, a 45-year-old homosexual male, presents to urgent care with throat pain and a rash. Returned from Africa 3 days ago where he was visiting his partner (practicing physician on mission trip). Partner was diagnosed with mpox while Jeremy was visiting — partner notified him the day he returned. Jeremy initially had low-grade fever and muscle fatigue before the rash appeared. Last night: small spots on lip and face. This morning: rash covering body. Reports throat pain and difficulty swallowing. Denies difficulty breathing.',
      background: 'Triage: screened positive for possible mpox infection. Two skin samples collected from lesion sites — sent to lab. Results pending. In macular phase — rash involves trunk, arms, and legs with some vesicular lesions. Throat erythematous with mild oedema. No respiratory distress. No exudate or tonsillar enlargement. Provider will evaluate after nursing assessment and standing orders implemented.',
      pastHistory: 'Depression (not currently taking medication — managing through diet, exercise, and outdoor activities). NKA.',
      social: 'Graphic designer. Lives alone in apartment. Homosexual male. In monogamous relationship with partner for 2 years (partner currently in Africa). History of oral sex exposure with partner while in Africa.',
      familyContact: 'Partner abroad (currently hospitalised with mpox).',
      objectives: [
        'Implement Airborne and Contact Precautions (with eye protection) BEFORE entering room.',
        'Conduct a focused assessment including skin, pain, respiratory, and social/exposure history.',
        'Implement standing nursing procedure for suspected mpox infection.',
        'Administer PRN ibuprofen 600 mg PO for pain per standing orders.',
        'Provide stigma-sensitive care and education on mpox transmission and reporting.',
      ],
      orders: [
        ['Precautions', 'Airborne AND Contact Precautions — EYE PROTECTION required', 'Don PPE before entering room', 'Active'],
        ['Nursing', 'Isolate patient in private room', 'Already done — private room', 'Active'],
        ['Nursing', 'Obtain vital signs', 'Part of standing nursing procedure', 'Active'],
        ['Nursing', 'Pain assessment', 'Part of standing nursing procedure', 'Active'],
        ['Nursing', 'Obtain social/exposure history', 'Document exposure to confirmed mpox case, travel, sexual contacts', 'Active'],
        ['Procedure', 'Obtain 2 specimen samples by swabbing lesions from 2 different sites', 'Nonvariola Orthopox (MPXV) PCR — triage already collected; pending results', 'Complete'],
        ['Medication', 'Ibuprofen 600 mg / 100 mg per 5 mL (30 mL = 600 mg) PO — PRN for pain (patient > 45 kg)', 'Standing PRN order per clinic protocol for confirmed mpox', 'PRN'],
        ['Nursing', 'Provide patient education on mpox transmission, home isolation, and contact notification', '', 'Active'],
        ['Nursing', 'Case reporting — document suspected mpox case per mandatory reporting protocol', '', 'Active'],
      ],
      labs: [
        ['Triage', 'Mpox PCR (Nonvariola Orthopox MPXV)', 'Pending — 2 specimens collected from lesions', 'Negative', 'Pending', 'Results may take 24–48 hours'],
      ],
      vitals: [],
      meds: [
        ['Ibuprofen', '600 mg (100 mg/5 mL — 30 mL)', 'PO', 'PRN for pain — per standing order (> 45 kg)', 'PRN', 'pending', 'Standing PRN order for patients > 45 kg with positive test result. Monitor for GI side effects.'],
      ]
    })
  },
  ...
  {
    id: 'pediatric_adhd',
    name: 'Pediatric ADHD — Behavioral Health Clinic',
    focus: 'Pediatrics / Behavioral Health',
    level: 'Beginner (Fundamentals)',
    summary: '8-year-old male presenting to pediatric behavioral health clinic for medication check. Diagnosed with ADHD, on methylphenidate. Vanderbilt Teacher Scale shows moderate inattention. Psychosocial concerns including social isolation and parental anxiety.',
    skills: ['Pediatric behavioral assessment', 'ADHD medication monitoring', 'Therapeutic communication', 'Psychosocial screening'],
    patient: patientTemplate({
      id: 'adhd-default', scenarioId: 'pediatric_adhd',
      firstName: 'Santiago', lastName: 'Ramos',
      age: '8', sex: 'Male', dob: '03/10', mrn: '51-00001',
      location: 'Pediatric Behavioral Health and Wellness Clinic',
      diagnosis: 'Attention Deficit Hyperactivity Disorder (ADHD) — Medication Management Visit',
      acuity: 'Stable', allergies: 'No Known Allergies',
      specialty: 'Pediatrics / Behavioral Health',
      tags: ['Pediatric', 'ADHD', 'Behavioral Health', 'Psychosocial', 'HCT'],
      gestation: 'N/A',
      chiefComplaint: 'Routine ADHD medication management check — concerns about social isolation',
      hpi: 'Santiago Ramos, an 8-year-old male in 3rd grade, is presenting to the behavioral health clinic for a routine medication check. He was diagnosed with ADHD 8 months ago and started on methylphenidate. His mother Leanna reports that while his schoolwork has improved, she is concerned about his increasing social isolation, difficulty making friends, and frustration with peers. Santiago said to his mother: "I feel like I live on my own planet! No one likes me."',
      background: 'Vanderbilt Teacher Assessment Scale completed by Mrs. Jillian Howe (class 7:25 am–3:30 pm, 3rd grade). Scale based on 6 months of observation, without medication. Shows "Often" to "Very Often" for inattention and hyperactivity items.',
      pastHistory: 'ADHD. No other medical history.',
      social: 'Lives with mother Leanna, father Julian, and two siblings (10-year-old Andre and 13-year-old Gabriela). 3rd grade. Difficulty with peer relationships. Spending increasing time alone. Mental health history in family.',
      familyContact: 'Mother Leanna Ramos — with patient today.',
      objectives: [
        'Verify patient identity with two identifiers.',
        'Review the EHR and assess current medication effectiveness.',
        'Conduct a focused nursing assessment including height, weight, vital signs, and neurological behaviour.',
        'Assess psychosocial wellbeing: mood, peer relationships, safety, and family concerns.',
        'Recognise priority nursing issues: social isolation, risk for anxiety, depression, and low self-esteem.',
      ],
      orders: [
        ['Nursing', 'Verify patient identity with two identifiers', 'NPS Goal', 'Active'],
        ['Nursing', 'Review EHR, medication list, and Vanderbilt assessment forms', '', 'Active'],
        ['Nursing', 'Obtain weight, height, and vital signs', 'Monitor growth on methylphenidate — appetite suppression concern', 'Active'],
        ['Nursing', 'Conduct age-appropriate nursing assessment', 'Behaviour, mood, sleep, appetite, social functioning', 'Active'],
        ['Nursing', 'Screen for anxiety, depression, and suicidal ideation', 'Age-appropriate screening', 'Active'],
        ['Medication', 'Methylphenidate immediate release 5 mg before school, 2.5 mg at 1200, 2.5 mg at 1600', 'PO three times daily', 'Scheduled'],
      ],
      labs: [
        ['Today', 'Weight', '22.1 kg', 'Age-appropriate range', 'Pending', 'Monitor trend — methylphenidate can suppress appetite'],
        ['Today', 'Height', 'Pending', 'Age-appropriate range', 'Pending', ''],
        ['Vanderbilt (Teacher)', 'Inattention Score', 'Often to Very Often on 8 of 9 items', 'Occasionally', 'Abnormal', 'Significant inattention and hyperactivity — not on medication during observation'],
      ],
      vitals: [],
      meds: [
        ['Methylphenidate IR', '5 mg', 'PO', 'Before school', 'Scheduled', 'pending', 'Monitor: appetite, sleep, growth, HR, BP, mood changes. Ask parent and child about side effects.'],
        ['Methylphenidate IR', '2.5 mg', 'PO', 'At 1200', 'Scheduled', 'pending', ''],
        ['Methylphenidate IR', '2.5 mg', 'PO', 'At 1600', 'Scheduled', 'pending', 'Last dose should not be given too late — may affect sleep.'],
      ]
    })
  },
  ...
  {
    id: 'end_of_life',
    name: 'End-of-Life Care: Stage 4 Pancreatic Cancer',
    focus: 'Medical-Surgical / Palliative',
    level: 'Intermediate',
    summary: '78-year-old female with stage 4 pancreatic cancer who chose supportive/hospice care. DNR. Current pain episode. Requires comfort-focused nursing care, morphine sublingual, therapeutic communication, and careful O2 titration.',
    skills: ['Comfort-focused care', 'Hospice nursing', 'Therapeutic communication', 'Pain management'],
    patient: patientTemplate({
      id: 'eol-default', scenarioId: 'end_of_life',
      firstName: 'Elizabeth', lastName: 'Longo',
      age: '78', sex: 'Female', dob: '06/21', mrn: '51-94001',
      location: 'Medical-Surgical Unit',
      diagnosis: 'Stage 4 Pancreatic Cancer — Supportive/Hospice Care',
      acuity: 'Watch',
      allergies: 'No Known Allergies',
      codeStatus: 'Do Not Resuscitate (DNR)',
      specialty: 'Medical-Surgical / Palliative Care',
      tags: ['DNR', 'Hospice', 'End of Life', 'Comfort care', 'HCT'],
      gestation: 'N/A',
      chiefComplaint: 'Fatigue, epigastric pain, weight loss, loss of appetite — Stage 4 pancreatic cancer',
      hpi: 'Elizabeth Longo, a 78-year-old female, arrived 4 days ago with fatigue, epigastric pain, 5 kg weight loss in 1 week, and loss of appetite. CT abdomen revealed stage 4 pancreatic cancer with metastases to the liver, abdominal wall, and lungs. Oncologist presented options: chemotherapy, clinical trial, or supportive care. Mrs. Longo and her son Barry chose supportive care. Hospice consulted. Patient is now being cared for with comfort-focused nursing.',
      background: 'Current orders: morphine sulfate 3 mg SL q2h PRN pain/dyspnoea, oxygen 2L NC for comfort, docusate sodium PRN. No lab draws. IV removed for comfort. CT showed pancreatic mass at head of pancreas. CT thorax also available.',
      pastHistory: 'Hypertension, Chronic back pain.',
      social: 'Widowed. Retired. Lives alone. Son Barry Longo — primary family support and at bedside.',
      familyContact: 'Son Barry Longo — at bedside.',
      objectives: [
        'Verify patient identity and review end-of-life orders.',
        'Conduct a comfort-focused assessment — pain, dyspnoea, skin, spiritual, psychosocial.',
        'Administer morphine sulfate 3 mg SL per comfort order — monitor respiratory rate.',
        'Administer oxygen 2L NC per order — do not increase without provider order.',
        'Provide therapeutic communication and emotional support to patient and son Barry.',
      ],
      orders: [
        ['Nursing', 'Vital signs with SpO2 every 4 hours', 'Comfort monitoring only — not for escalation', 'Active'],
        ['Diet', 'Diet as tolerated — comfort', 'Small amounts if desired', 'Active'],
        ['Nursing', 'Reposition patient every 2 hours or as needed for comfort', '', 'Active'],
        ['Nursing', 'Remove peripheral IV for comfort (done)', '', 'Complete'],
        ['Respiratory', 'Administer oxygen 2L via nasal cannula for comfort', 'Do NOT titrate up or down without provider order', 'Active'],
        ['Labs', 'No lab draws', 'Comfort care — hospice', 'Active'],
        ['Medication', 'Morphine sulfate 3 mg SL every 2 hours PRN pain or dyspnoea', 'Comfort order — offer, may refuse', 'PRN'],
        ['Medication', 'Docusate sodium 100 mg PO daily PRN constipation', '', 'PRN'],
      ],
      labs: [
        ['4 days ago', 'CT Abdomen', 'Pancreatic mass at head of pancreas with metastases to liver, abdominal wall, and lungs', 'Normal', 'Abnormal', 'Read by Dr. Cheryl Natalia (Radiologist)'],
        ['4 days ago', 'CT Thorax', 'Pulmonary metastases', 'Normal', 'Abnormal', 'Read by Dr. Cheryl Natalia (Radiologist)'],
      ],
      vitals: [{
        time: 'Today 10:00', hr: 88, bps: 110, bpd: 64, rr: 20, temp: '37.1',
        spo2: 93, pain: '6', fetal: 'N/A',
        note: 'Patient in pain. Son Barry at bedside. Dyspnoeic at rest. On 2L NC per comfort order. Mouth breathing.',
        by: 'Day RN'
      }],
      meds: [
        ['Morphine Sulfate', '3 mg', 'Sublingual', 'q2h PRN pain or dyspnoea — offer, may refuse', 'PRN', 'pending', 'Comfort measure. Monitor RR before administration. Do not administer if RR < 10.'],
        ['Docusate Sodium', '100 mg', 'PO daily', 'PRN constipation', 'PRN', 'pending', 'Comfort measure.'],
      ]
    })
  },
  ...
  {
    id: 'covid19',
    name: 'COVID-19: Medical-Surgical Admission',
    focus: 'Medical-Surgical / Infectious Disease',
    level: 'Intermediate',
    summary: '52-year-old male admitted for COVID-19 with SpO2 87% on 2L NC on arrival. On remdesivir, dexamethasone, and enoxaparin. Requires airborne + contact + eye protection PPE, patient identification, medication administration, and positioning.',
    skills: ['Airborne PPE', 'COVID-19 management', 'Antiviral administration', 'Prone/positioning'],
    patient: patientTemplate({
      id: 'covid-default', scenarioId: 'covid19',
      firstName: 'Aaron', lastName: 'Clark',
      age: '52', sex: 'Male', dob: '07/31', mrn: '51-67001',
      location: 'Medical/Surgical Unit',
      diagnosis: 'COVID-19 with Hypoxaemic Respiratory Failure',
      acuity: 'Watch',
      allergies: 'No Known Allergies',
      specialty: 'Medical-Surgical / Infectious Disease',
      tags: ['COVID-19', 'Airborne', 'Contact', 'HIGH-ALERT Enoxaparin', 'HCT'],
      gestation: 'N/A',
      chiefComplaint: 'Worsening COVID-19 — fever, persistent cough, shortness of breath, SpO2 87%',
      hpi: 'Aaron Clark, a 52-year-old male, was diagnosed with COVID-19 one week ago by his PCP after exposure from a co-worker. Initially self-quarantined with fatigue, muscle aches, and headache. Yesterday, condition worsened — presented to ED with fever 101°F (38.3°C), persistent cough, and SOB with SpO2 87%. Placed on 2L O2 NC in ED. Administered acetaminophen 650 mg PO. Admitted to Med-Surg and started on dexamethasone, remdesivir, and enoxaparin.',
      background: 'Morning vitals: HR 98; RR 22; BP 138/84; T 99.4°F; SpO2 93% on 2L NC. Did not receive COVID-19 vaccine. Lives with wife (remote worker) and 2 college-age children (not at home). Manager of a local grocery store. The rest of the household is asymptomatic.',
      pastHistory: 'Hypertension, Hyperlipidaemia. No COVID-19 vaccination.',
      social: 'Married, 2 adult children. Grocery store manager. Family was exposed — wife is asymptomatic remote worker.',
      familyContact: 'Wife — at home (remote work). Contactable.',
      objectives: [
        'Don appropriate PPE: N95 respirator, isolation gown, face shield, gloves BEFORE entering room.',
        'Verify patient ID using two identifiers.',
        'Review EHR, labs, and provider orders.',
        'Administer scheduled lisinopril 20 mg PO.',
        'Administer enoxaparin 40 mg SQ — HIGH-ALERT dual verification.',
        'Position patient seated or in Fowler\'s to optimise oxygenation.',
      ],
      orders: [
        ['Precautions', 'Contact AND Airborne Precautions with eye protection', 'Don: gown → N95 → face shield → gloves. Doff in reverse with hand hygiene.', 'Active'],
        ['Monitoring', 'Continuous SpO2 monitoring', 'Titrate O2 to maintain SpO2 > 92%', 'Active'],
        ['Nursing', 'Vital signs every 4 hours and as needed', 'Notify for RR > 28, SpO2 < 90%, HR > 110', 'Active'],
        ['Nursing', 'Encourage prone positioning or seated position', 'Awake proning for 2–4 hours at a time if tolerated', 'Active'],
        ['Medication', 'Dexamethasone 6 mg PO/IV daily × 10 days', 'Corticosteroid for COVID-19', 'Scheduled'],
        ['Medication', 'Remdesivir 200 mg IV on Day 1, then 100 mg IV daily × 4 days', 'Antiviral — Day 2 today (100 mg)', 'Scheduled'],
        ['Medication', 'Enoxaparin 40 mg SQ daily', 'HIGH-ALERT LMWH — VTE prophylaxis. Dual verification required.', 'Scheduled'],
        ['Medication', 'Lisinopril 20 mg PO daily', 'Home antihypertensive — continue', 'Scheduled'],
        ['Medication', 'Acetaminophen 650 mg PO q6h PRN fever > 38°C or pain', '', 'PRN'],
        ['Lab', 'CBC, CMP, CRP, D-dimer, ferritin, LDH — daily', 'COVID-19 inflammatory markers', 'Active'],
        ['Imaging', 'Chest X-ray — daily', 'Monitor pulmonary infiltrates', 'Active'],
      ],
      labs: [
        ['Yesterday (ED)', 'COVID-19 PCR', 'POSITIVE', 'Negative', 'Critical', 'Confirmed COVID-19'],
        ['Yesterday (ED)', 'SpO2 on RA', '87%', '≥ 95%', 'Critical', 'Hypoxaemic on room air — 2L NC started'],
        ['Today AM', 'CRP', '68 mg/L', '< 1 mg/L', 'High', 'Elevated — significant inflammation'],
        ['Today AM', 'D-Dimer', '1.8 µg/mL FEU', '< 0.5', 'High', 'Elevated — coagulopathy risk; enoxaparin ordered'],
        ['Today AM', 'Ferritin', '820 ng/mL', '12–300', 'High', 'Elevated — COVID-19 hyperinflammatory state'],
        ['Today AM', 'WBC', '9.2 K/µL', '5.0–10.0', 'Normal', ''],
        ['Today AM', 'Lymphocytes', '0.8 K/µL', '1.0–4.8', 'Low', 'Lymphopenia — typical COVID-19'],
        ['Today', 'Chest X-Ray', 'Bilateral peripheral infiltrates — patchy', 'Clear', 'Abnormal', 'Consistent with COVID-19 pneumonitis'],
      ],
      vitals: [{
        time: 'AM vitals', hr: 98, bps: 138, bpd: 84, rr: 22, temp: '99.4',
        spo2: 93, pain: '2', fetal: 'N/A',
        note: 'SpO2 93% on 2L NC. Tachypnoeic. Productive cough. Seated position improves SpO2 to 95%. Contact + Airborne precautions in place.',
        by: 'Night shift RN'
      }],
      meds: [
        ['Remdesivir', '100 mg (Day 2)', 'IV infusion over 30–60 min', 'Daily × 4 more days', 'Scheduled', 'pending', 'Antiviral. Monitor infusion site and renal function.'],
        ['Dexamethasone', '6 mg', 'PO or IV', 'Daily × 10 days', 'Scheduled', 'pending', 'Corticosteroid. Monitor glucose (hyperglycaemia side effect). Give with food if PO.'],
        ['Enoxaparin', '40 mg / 0.4 mL', 'SQ injection', 'Once daily', 'Scheduled', 'pending', 'HIGH-ALERT LMWH — dual verification required. Inject abdomen 90°. Monitor for bleeding. Check renal function.'],
        ['Lisinopril', '20 mg', 'PO daily', 'Daily', 'Scheduled', 'pending', 'Home antihypertensive. Continue per protocol. Hold if SBP < 100.'],
        ['Acetaminophen', '650 mg', 'PO q6h', 'PRN fever > 38°C or pain', 'PRN', 'pending', 'For fever and pain management.'],
      ]
    })
  }
...
function rReport(){
  ...
  // ── Medication sections by status ─────────────────────────────────────────
  const MED_CATS = ['medication','med','drug','iv fluids','iv','infusion','analgesic','antibiotic','new order'];
  function isMedOrder(o){
    const cat=(o.category||'').toLowerCase();
    const ord=(o.order||'').toLowerCase();
    return MED_CATS.some(k=>cat.includes(k)||ord.startsWith(k));
  }
  const existingNames = new Set((p.meds||[]).map(m=>(m.name||'').toLowerCase().trim()));
  const syncedMeds   = (p.orders||[])
    .filter(o=>isMedOrder(o)&&!existingNames.has((o.order||'').toLowerCase().trim()))
    .map((o,idx)=>({id:`sync-${idx}`,name:o.order,dose:o.details||'—',route:'',freq:o.status,
      priority:o.category,status:o.nurseCompleted?'given':'pending',time:'',note:'',warn:'',_fromOrder:true}));
  const allMeds = [...(p.meds||[]),...syncedMeds];
 
  function medSection(label, statusKey, colorClass){
    ...
    const rows = subset.map(m=>{
      ...
      return `<tr>
        <td>
          ...
          ${m._fromOrder?` <span style="font-size:9px;color:var(--info);">(order)</span>`:''}
          ${warn?`<br><span style="font-size:10px;color:var(--danger);font-weight:800;">⚠ ${esc(warn)}</span>`:''}
        </td>
        <td>${esc(m.dose)}</td>
        <td>${esc(m.route)}</td>
        <td>${esc(m.freq)}</td>
        <td>${m.time ? esc(nowDisplay(m.time)) : '—'}</td>
        <td style="font-size:11px;color:var(--muted);">${m.note ? esc(m.note) : '—'}</td>
        <td><span class="badge ${colorClass}">${esc(m.status)}</span></td>
      </tr>`;
    }).join('');
    return `<p style="font-size:10px;font-weight:800;text-transform:uppercase;
      color:var(--muted);margin:10px 0 4px;letter-spacing:.06em;">${label}</p>
      ${table(['Medication','Dose','Route','Freq','Time','Note','Status'], rows)}`;
  }
 
  const medBlock = allMeds.length
    ? (medSection('✓ Given',     'given',    'green') ||'')
    + (medSection('⏸ Held',      'hold',     'gold')  ||'')
    + (medSection('✗ Not given', 'not_given','red')   ||'')
    + (medSection('○ Pending',   'pending',  'blue')  ||'')
    : '<p style="color:var(--subtle);font-size:12px;padding:4px 0;">No medications on MAR.</p>';
  ...
  // ── Alerts ────────────────────────────────────────────────────────────────
  const allergyAlerts = allMeds
    .map(m => checkMedAllergy(m.name, p.allergies))
    .filter(Boolean);
 
  const alertsHTML = [
    ...vAlerts.map(r=>`<div class="notice danger" style="padding:7px 10px;margin-bottom:5px;">
      <span class="mark">⚠ ${esc(r.label)}</span>
      <span style="font-size:11px;">${esc(r.msg)}</span></div>`),
    ...allergyAlerts.map(a=>`<div class="notice danger" style="padding:7px 10px;margin-bottom:5px;">
      <span class="mark">🚨 ALLERGY</span>
      <span style="font-size:11px;">${esc(a)}</span></div>`),
  ].join('') || '<p style="color:var(--subtle);font-size:12px;">No active alerts.</p>';
 
  // ── Notes ─────────────────────────────────────────────────────────────────
  const notesHTML = (p.notes||[]).slice(-5).map(n=>`
    <div class="note">
      <div class="note-head">
        <span><span class="note-type">${esc(n.type)}</span> | ${esc(nowDisplay(n.time))} | ${esc(n.by)}</span>
      </div>
      <div class="note-body">${lines(n.body)}</div>
    </div>`).join('') || '<p class="text-block" style="color:var(--subtle);">No notes documented.</p>';
 
  // ── Peer review ───────────────────────────────────────────────────────────
  const peerHTML = (p.peerReviews||[]).length
    ? (p.peerReviews||[]).map(r=>`<li><strong>${esc(r.reviewer)} (${esc(r.score)}/5):</strong>
        ${esc(r.strength)} — ${esc(r.growth)}</li>`).join('')
    : '<li style="color:var(--subtle);">No peer review saved.</li>';
 
  // ── Assessment narrative ──────────────────────────────────────────────────
  const assessHTML = p.assessment?.narrative
    ? `<p class="text-block">${lines(p.assessment.narrative)}</p>
       <div class="grid-2" style="margin-top:10px;">
         ${field('Neuro',      p.assessment.neuro)}
         ${field('Respiratory',p.assessment.resp)}
         ${field('Cardiac',    p.assessment.cardiac)}
         ${field('GI',         p.assessment.gi)}
         ${field('GU / Output',p.assessment.gu)}
         ${field('Skin / Wound',p.assessment.skin)}
         ${field('Pain',       p.assessment.pain)}
         ${field('Safety',     p.assessment.safety)}
       </div>`
    : '<p style="color:var(--subtle);font-size:12px;">Assessment not documented.</p>';
 
  // ── Care plan ─────────────────────────────────────────────────────────────
  const carePlanRows = (p.carePlan||[]).filter(c=>c.dx).map(c=>`<tr>
    <td>${esc(c.dx)}</td>
    <td style="font-size:11px;">${esc(c.goal)}</td>
    <td style="font-size:11px;">${esc(c.interventions)}</td>
    <td style="font-size:11px;">${esc(c.evaluation)}</td>
  </tr>`).join('') || '<tr><td colspan="4" style="color:var(--subtle);">No care plan documented.</td></tr>';
 
  // ── Education ─────────────────────────────────────────────────────────────
  const eduRows = (p.education||[]).map(e=>`<tr>
    <td>${esc(e.topic)}</td>
    <td><span class="badge ${e.status==='Complete'?'green':e.status==='In progress'?'gold':'blue'}">${esc(e.status)}</span></td>
    <td style="font-size:11px;">${esc(e.response||'—')}</td>
  </tr>`).join('') || '<tr><td colspan="3" style="color:var(--subtle);">No education documented.</td></tr>';
 
  // ── Clinical reasoning ────────────────────────────────────────────────────
  const prompts  = getPrompts(p.scenarioId);
  const rr       = p.reasoningResponses||{};
  const reasoningHTML = prompts.map((q,i)=>`
    <div style="margin-bottom:10px;padding:8px;background:var(--surface);border-radius:6px;border:1px solid var(--line);">
      <p style="font-size:11px;font-weight:800;color:var(--muted);margin:0 0 4px;">${esc(q)}</p>
      <p style="font-size:12px;margin:0;">${rr[i] ? esc(rr[i]) : '<em style="color:var(--subtle);">No response</em>'}</p>
    </div>`).join('') || '<p style="color:var(--subtle);font-size:12px;">No reasoning responses.</p>';
 
  // ── Debriefing ────────────────────────────────────────────────────────────
  const d = p.debriefing||{};
  const debriefHTML = d.selfScore || d.strengths || d.improvements ? `
    <div class="grid-2">
      ${field('Self-score', d.selfScore ? d.selfScore+'/100' : '--')}
      ${field('Facilitator score', d.facilNotes ? '(see notes)' : '--')}
    </div>
    ${d.strengths    ? `<p style="font-size:12px;margin:6px 0 2px;"><strong>What went well:</strong> ${lines(d.strengths)}</p>` : ''}
    ${d.improvements ? `<p style="font-size:12px;margin:6px 0 2px;"><strong>What to improve:</strong> ${lines(d.improvements)}</p>` : ''}
    ${d.facilNotes   ? `<p style="font-size:12px;margin:6px 0 2px;"><strong>Facilitator notes:</strong> ${lines(d.facilNotes)}</p>` : ''}`
    : '<p style="color:var(--subtle);font-size:12px;">Debriefing not completed.</p>';
  ...
  return `<div class="print-report">
    ...
    ${section('Printable chart report',`
      <div class="notice info" style="margin-bottom:10px;">
        <span class="mark">REPORT</span>
        <span>Complete chart report — vitals, medications, I/O, assessment, care plan, education, reasoning, and debriefing.</span>
      </div>
      <div class="actions" style="justify-content:flex-start;">
        <button class="btn primary" onclick="window.print()">🖨️ ${tr('printReport')}</button>
      </div>
    `)}
    ...
    ${section('Patient snapshot',`
      <div style="display:flex;align-items:center;gap:10px;margin-bottom:10px;">
        <div style="flex:1;height:8px;background:var(--line);border-radius:999px;overflow:hidden;">
          <div style="height:100%;width:${score}%;background:${scoreColor};border-radius:999px;transition:width .4s;"></div>
        </div>
        <span style="font-size:12px;font-weight:800;color:${scoreColor};">${score}% complete</span>
      </div>
      <div class="grid-4">
        ${field('Patient',`${p.lastName}, ${p.firstName}`)}
        ${field('MRN', p.mrn)}
        ${field('DOB / Age',`${p.dob} / ${p.age}y`)}
        ${field('Sex', p.sex)}
        ${field('Diagnosis', p.diagnosis)}
        ...
        ${field('Location', p.location)}
        ${field('Specialty', p.specialty)}
        ${p.gestation && p.gestation!=='N/A' ? field('Gestation', p.gestation) : ''}
        ${field('Attending', p.attending||'Simulation provider')}
      </div>
    `)}
 
    ${section('Active alerts',alertsHTML)}
    ...
    ${section('Latest vital signs',`
      <div class="grid-4" style="margin-bottom:12px;">
        ...
        ${fieldRaw('Pain',       `${esc(String(last.pain||'--'))}/10`)}
        ${fieldRaw('Time',       esc(nowDisplay(last.time||'')))}
        ${fieldRaw('Note',       esc(String(last.note||'--')))}
      </div>
      <p style="font-size:10px;font-weight:800;text-transform:uppercase;color:var(--muted);
        letter-spacing:.06em;margin:0 0 6px;">All vital signs</p>
      ${table(['Time','HR','BP','RR','SpO\u2082','Temp','Pain','Note'], vitalsRows)}
    `)}
    ...
    ${section('Focused assessment', assessHTML)}
 
    ${section('Nursing care plan',
      table(['Nursing Diagnosis','Goal','Interventions','Evaluation'], carePlanRows)
    )}
 
    ${section('Patient education',
      table(['Topic','Status','Patient Response'], eduRows)
    )}
 
    ${section('Signed nursing notes (last 5)', notesHTML)}
 
    ${section('Clinical reasoning responses', reasoningHTML)}
 
    ${section('Simulation debriefing', debriefHTML)}
 
    ${section('Peer review summary',`<ul class="interactive-list">${peerHTML}</ul>`)}
