(function(){
  ...
  function apply(msg){if(!msg||msg.cid===cid||!msg.locks)return;locks=clean({...locks,...msg.locks});save();paint()}
  ...
  function claim(id){if(!id)return;locks=clean(locks);locks[id]={cid,owner:who(),expires:Date.now()+60000};save();publish();paint()}
